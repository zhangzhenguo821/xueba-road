...
const CHIPS = [
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "易错操作", "description": "把差量算成 5−2=3", "fix": "对照口诀逐项检查，画出关键数量关系再列式"}, {"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}],
    "transfer": {"description": "掌握了「鸡兔同笼倒扣分问题·两分钟掌握」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "易错操作", "description": "直接拿 36÷3=12", "fix": "对照口诀逐项检查，画出关键数量关系再列式"}, {"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}],
    "transfer": {"description": "掌握了「年龄问题·四年级奥数基础」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-010",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「和差问题·三年级奥数第七讲」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-013",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「归一问题·小学数学必学」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-014",
...
,
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算小数×整数、小数×小」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-025",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算加法交换律·结合律、」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-022",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算试商技巧与验算时频繁」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-018",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算小数读写、大小比较、」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-023",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画沏茶问题与对策论时图形画反、」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-020",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画量角器使用与角度计算时图形画」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-016",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算竖式对齐与进退位时频」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-024",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算加减乘除混合运算与括」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-021",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算亿以内数的读写与比较」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-015",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算竖式乘法与估算时频繁」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-017",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画平均数含义与计算、复式条形统」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-027",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画从不同方向观察立体图形时图形」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-028",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算综合实践：数据收集与」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-04-030",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画数据整理与图表绘制时图形画反」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "CHI-04-010",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算除数是整数·小数的除」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-006",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算倒数的认识、分数除法」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-021",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画平行四边形·三角形·梯形·组」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-009",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画特征识别、表面积与体积公式时」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-014",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「遇到植树问题的应用题，孩子读完」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-010",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算小数乘整数·小数、积」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-004",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算同分母·异分母加减法」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-016",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算分数×整数、分数×分」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-020",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画圆的认识、周长与面积公式时图」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-023",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算分数意义、真分数假分」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-015",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算因数·倍数概念、2·」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-013",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算比的意义、化简比、按」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-022",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算用天平找次品的最优策」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-018",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画三视图初步——从三个方向还原」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-012",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画旋转与旋转作图时图形画反、公」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-019",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算事件确定性与不确定性」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-007",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算数对表示位置(列,行」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-005",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算单式·复式折线统计图」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-05-017",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画数字编码与身份证号码时图形画」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "CHI-05-012",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算分数除以整数·分数、」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-006",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「遇到行程问题的应用题，孩子读完」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-018",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「遇到工程问题的应用题，孩子读完」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-017",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「遇到浓度问题的应用题，孩子读完」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-019",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画圆周长·面积公式推导与应用、」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-008",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算比例意义与性质、正比」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-015",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "思路卡顿", "description": "设未知数就卡住了", "fix": "回想课堂上的解题步骤，按流程一步步走"}, {"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}],
    "transfer": {"description": "掌握了「列方程时找不到等量关系，设未知」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-021",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算假设法与方程法综合应」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-022",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「遇到利润问题的应用题，孩子读完」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-020",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算分数乘分数、分数混合」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-004",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算折扣·成数·税率·利」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-013",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算比的基本性质、化简比」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-007",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算百分数意义、百分数·」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-009",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算数与代数·图形与几何」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-016",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画数形结合思想、找规律时图形画」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-011",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算负数认识、数轴与负数」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-012",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「画扇形统计图读图与信息提取、选」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "MATH-06-010",
  ...
  ,
    ...
    "solveSteps": [{"step": "第1步", "detail": "读题：圈出已知条件和所求问题，明确数量关系"}, {"step": "第2步", "detail": "列式：根据数量关系列出算式或方程"}, {"step": "第3步", "detail": "计算：认真计算每一步，注意进位退位"}, {"step": "第4步", "detail": "检验：把答案代回原题，检查是否合理"}],
    "commonMistakes": [{"type": "计算失误", "description": "加减乘除计算时出错，进位退位遗漏", "fix": "每步计算后快速心算验证，用逆运算验算"}, {"type": "审题不清", "description": "看错数字、漏看条件、误解题意", "fix": "圈出题目中的关键数字和条件词，读两遍再动笔"}, {"type": "单位遗漏", "description": "忘记写单位或单位换算错误", "fix": "答题前确认单位是否统一，答案后检查是否写了单位"}],
    "transfer": {"description": "掌握了「孩子在计算用方向和距离确定位置」的核心方法后，同类题型的解题思路都是相通的：找关键量→列关系式→解算式→检验。", "relatedTopics": ["鸡兔同笼→得分扣分→买票问题→组船问题", "和差问题→和倍问题→差倍问题→年龄问题"]},
    "advanced": {"description": "本知识点建立的解题工具在后续列方程解应用题、函数图像分析中直接使用", "futureTopics": ["列方程解应用题", "函数变量关系", "概率统计"]},
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}]},
  {
    id: "CHI-06-006",
