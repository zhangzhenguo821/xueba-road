...
const CHIPS = [
  ...
  ,
    ...
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生做错时", "question": "再读一遍题，你发现刚才漏掉了哪个关键条件？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}],
    solveSteps: [
      {step: "第1步·辨识题型", detail: "判断属于哪种分配律题型：①标准型 a×(b+c)；②逆用型 a×b+a×c；③拆数型 99→100-1；④补数型 101→100+1；⑤缺项型 补×1；⑥多次分配型 (a+b)×(c+d)；⑦隐藏公因数型。"},
      {step: "第2步·找公因数", detail: "逆用型关键：找到相同的乘数（公因数）。例如：25×4+25×6 → 公因数=25 → 提取：25×(4+6)。隐藏型要找'倍数关系'：12×8+6×16 → 6×16=6×2×8 → 公因数=8×?。"},
      {step: "第3步·拆数凑整", detail: "拆数型利用'好朋友数'：99=100-1 → 78×99=78×100-78×1=7800-78=7722；25×4=100、125×8=1000。"},
      {step: "第4步·展开验证", detail: "把结果代回展开式验证：25×(4+6)=25×10=250，展开：25×4+25×6=100+150=250，一致。"}
    ],
    commonMistakes: [
      {type: "括号外只乘第一项", description: "(a+b)×c 只写成 a×c+b，漏了 b×c。例如：8×(5+3)错算成8×5+3=43。正解：8×5+8×3=64。", fix: "口诀：括号外的数要跟括号里每一个数都握一次手，一个都不能少。"},
      {type: "逆用型漏掉'1'", description: "a×b+a 看不出公因数 a，因为第二项 a=a×1。例如：37×99+37 不会提取，正解：37×(99+1)=37×100=3700。", fix: "技巧：任何数都可以写成它自己×1。见到'单独的加数'，补上×1。"},
      {type: "拆数时符号弄反", description: "78×99 拆成 78×100+78＝7878（错误）。正解：99=100-1，所以 78×99=78×100-78×1=7722。", fix: "拆数后符号跟随：99=100-1（减1），101=100+1（加1）。"}
    ],
    oneLineModel: "乘法分配律 = 括号外的数分别乘以括号里的每一个数再求和，正向展开、逆向提取，核心是'不重不漏'。",
    transfer: {
      description: "整数分配律→小数分配律（四下）→分数分配律（五下），定律不变；分配律的'拆数凑整'思维衔接五年级简便运算和六年级百分数速算。",
      relatedTopics: ["四年级简便运算综合", "五年级小数分配律", "五年级分数分配律", "六年级提取公因数与因式分解"]
    },
    advanced: {
      description: "分配律的正用与逆用是代数恒等变形的基础，多项式的展开与因式分解本质上就是分配律在字母运算中的推广。",
      futureTopics: ["多项式乘法展开", "提取公因式（初中因式分解第一步）", "平方差公式 a²-b²=(a+b)(a-b)", "二项式定理入门"]
    },
    aiDiagnosis: {
      trigger: "做错时弹出",
      action: "乘法分配律卡住通常两个原因：①正向展开时漏乘了括号里的某一项；②逆向提取时没发现隐藏的公因数。请把算式再写一遍，逐一检查括号外乘了几次。",
      interactionType: "dynamic-question"
    }
  },
  {
  ...
  ,
    ...
    "aiDiagnosisFollowUp": [{"level": 1, "trigger": "学生卡住时", "question": "回忆一下，这道题和我们之前练过的哪类题型很像？"}, {"level": 2, "trigger": "第一问回答后", "question": "试着把题目中的数量关系用简单的图画出来，你发现了什么？"}, {"level": 3, "trigger": "解题完成后", "question": "做完后别着急交，用逆运算验算一遍，答案合理吗？"}],
    solveSteps: [
      {step: "第1步·区分四个速度", detail: "明确四个核心速度：船速（静水速度）、水速（流速）、顺水速度 = 船速+水速、逆水速度 = 船速-水速。例如：船速20km/h，水速5km/h → 顺水25km/h，逆水15km/h。"},
      {step: "第2步·找已知求未知", detail: "根据题目给的已知条件，套入公式：船速 = (顺水速度+逆水速度)÷2；水速 = (顺水速度-逆水速度)÷2。例如：顺水30逆水18 → 船速=(30+18)÷2=24，水速=(30-18)÷2=6。"},
      {step: "第3步·算路程或时间", detail: "路程 = 速度 × 时间。注意顺水和逆水的速度不同，分段计算。例如：顺水2小时行50km，逆水3小时行45km，总路程=95km。"},
      {step: "第4步·检验合理性", detail: "水速必须小于船速（否则逆水无法前进），顺水速度>船速>逆水速度。代入检验：船速-水速>0 且 船速+水速>船速-水速。"}
    ],
    commonMistakes: [
      {type: "顺逆速度混淆", description: "把顺水速度当船速直接计算，忘了减水速。正解：顺水速度=船速+水速，题目给的'在河里的速度'通常是顺水或逆水速度，不是船速。", fix: "读题时圈出关键词：'顺流而下'=顺水速度，'逆流而上'=逆水速度，'静水中'=船速。"},
      {type: "求船速水速时公式反了", description: "用(顺水速度-逆水速度)÷2求出了船速而不是水速。正解：(顺+逆)÷2=船速，(顺-逆)÷2=水速。简称'和大船，差小水'。", fix: "口诀：和大船（加一起÷2得船速），差小水（相减÷2得水速）。"},
      {type: "来回平均速度用算术平均", description: "顺水去逆水回，平均速度≠(顺水速度+逆水速度)÷2。正解：平均速度=总路程÷总时间。", fix: "平均速度永远=总路程÷总时间。除非两段时间相等，否则不能用算术平均。"}
    ],
    oneLineModel: "流水行船 = 船速和水速的合成与分解：顺水做加法，逆水做减法；(顺+逆)÷2得船速，(顺-逆)÷2得水速。",
    transfer: {
      description: "流水行船是'速度合成'的经典模型，为六年级比例行程和初中物理的'相对速度'奠定基础；和差问题思维贯穿整个行程问题体系。",
      relatedTopics: ["四年级行程问题（速度×时间=路程）", "五年级火车过桥（车长+桥长）", "六年级比例行程", "初中物理·相对速度与参照系"]
    },
    advanced: {
      description: "流水行船的'和差'本质可推广到扶梯问题（人速+梯速）、传送带问题；方程法求解流水行船是二元一次方程组的实际应用。",
      futureTopics: ["扶梯问题（自动扶梯上行/下行）", "传送带问题（顺向/逆向）", "风速问题（顺风/逆风飞行）", "二元一次方程组解法"]
    },
    aiDiagnosis: {
      trigger: "做错时弹出",
      action: "流水行船一共四个速度：船速、水速、顺水速度、逆水速度。你卡住大概率是把顺水速度当成了船速。请先确认：题目给的到底是'静水速度'还是'水流中的速度'？",
      interactionType: "choice-question"
    }
  },
  {
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是英语基础差，而是看到英语题目就紧张想放弃。先试试：深呼吸，告诉自己\"我能看懂至少一半\"。先找出题目里你认识的词，猜猜整句话的意思。很多时候卡住是因为害怕，不是不会。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·看懂题目要求：用笔画出题目中的指令词。Circle/Choose/Fill in/Answer/Match→明确要做什么。",
            "第2步·激活相关知识：回想这个单元学过的单词/句型/语法。题目不会考超出课本范围的内容。",
            "第3步·逐题解答：从简单的开始做。单选题先排除明显错的选项，阅读理解先看题再看文。",
            "第4步·检查：通读一遍答案→拼写是否正确→首字母大写→标点符号→时态一致。简单错误最容易丢分。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "题目指令没读懂",
                "fix": "Circle=圈出，Underline=画线，Cross out=划掉。这些指令词要背熟"
              },
              {
                "type": "粗心拼写错误",
                "fix": "常见的拼写错误：beacuse→because，freind→friend，thier→their"
              },
              {
                "type": "中式英语表达",
                "fix": "多用课本里出现过的句型，不要自己\"发明\"英语句子"
              }
            ]
      ,
        "oneLineModel": "英语=词汇+语法+技能(听说读写)。多听→会读，多说→会写，多练→会用。"
      ,
        "transfer": "6年级英语→7年级能力提升→初中英语综合→高中英语进阶。"
      ,
        "advanced": "英语学习策略（可理解输入假说）、语感的科学培养、二语习得关键期理论。"
      }
,
  {
        "id": "MATH-05-008",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算加减乘除，而是不知道该对等式两边做什么。先试试：把方程3x+5=20想象成一个天平，左边有3个x块和5克砝码，右边有20克砝码。要让天平平衡还只剩x——先从两边各拿走5克，再每边分成3份。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·找等量关系把文字翻译成方程：\"一个数的3倍加5等于20\"→设这个数为x→3x+5=20。\"小明有x本书，小华是他2倍多3本\"→小华=2x+3。",
            "第2步·移项（把未知数放一边）：等式两边同时操作。3x+5=20→两边减5→3x+5-5=20-5→3x=15。",
            "第3步·系数化为1：两边同时除以未知数的系数。3x÷3=15÷3→x=5。",
            "第4步·检验：把x=5代入原方程→3×5+5=15+5=20✓。方程的解必须使等式成立。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "移项不变号",
                "description": "3x+5=20→移项后写成3x=20+5（应为20-5）。",
                "fix": "移项=等式两边同时做相同运算。把+5移到右边→两边同时减5，右边20-5。"
              },
              {
                "type": "系数处理错误",
                "description": "3x=15→x=15×3=45（应该÷3）。",
                "fix": "3x表示3乘以x，要得到x需要除以3。两边同时÷3。"
              },
              {
                "type": "检验省略或形式化",
                "description": "算出x=5直接写答，不代入验证。",
                "fix": "代入检验三步：①把x值代入左边算结果→②看是否等于右边→③写检验结论。必须真算，不能凭感觉。"
              }
            ]
      ,
        "oneLineModel": "方程=含未知数的等式。解法：等量关系→设未知数→列方程→移项→系数化1→检验。"
      ,
        "transfer": "简易方程→五年级实际问题与方程（设未知数解题）→六年级列方程解应用题→初中一元一次方程→初二二元一次方程组。"
      ,
        "advanced": "方程的同解变形原理、含括号的方程（先去括号再移项）、ax+b=cx+d型（两边都有未知数）、用方程解和差倍问题与年龄问题。"
      }
,
  {
        "id": "MATH-06-014",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会背公式，而是圆锥体积忘记乘以1/3。先试试：一个底面半径5cm、高12cm的圆锥，先算等底等高圆柱体积=π×25×12=300π≈942cm³，然后×1/3=314cm³。每次算圆锥都在心里默念：\"三分之一，三分之一，三分之一！\"",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·圆柱表面积：S=2πr²+2πrh=2πr(r+h)。两个底面积=2×πr²，侧面积=底面周长×高=2πrh。例如r=5cm,h=10cm→S=2×3.14×5×(5+10)=31.4×15=471cm²。",
            "第2步·圆柱体积：V=Sh=πr²h。底面半径5cm高10cm→V=3.14×25×10=785cm³。容积=内部空间体积，算法相同。",
            "第3步·圆锥体积：V=1/3×Sh=1/3×πr²h。底面半径5cm高12cm→V=1/3×3.14×25×12=3.14×100=314cm³。等底等高的圆柱和圆锥：V柱=3V锥。",
            "第4步·实际应用：水桶装水=圆柱容积。沙堆=圆锥体积。计算时注意给出的数据是半径还是直径→d=10→r=5。单位统一：1L=1000cm³→785cm³=0.785L。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "圆柱表面积漏掉底面积",
                "description": "只算侧面积2πrh，忘记加两个底面积2πr²。如要求\"铁皮用多少\"需总面积。",
                "fix": "先判断几个面：有盖=2个底+侧面，无盖=1个底+侧面，通风管=0个底+侧面。"
              },
              {
                "type": "圆锥忘乘1/3",
                "description": "V锥=πr²h（漏了1/3），导致体积是正确值的3倍。",
                "fix": "圆锥是和它等底等高圆柱的1/3。公式：V锥=1/3×πr²h。永远不要忘记1/3。"
              },
              {
                "type": "半径直径混淆",
                "description": "告诉直径10cm，代入公式时用了10当r→V=π×100×h=100πh（应为25πh）。",
                "fix": "遇到\"直径\"先÷2得半径，再代入公式。在题目上圈\"直径\"→旁边写\"r=d÷2\"。"
              }
            ]
      ,
        "oneLineModel": "圆柱S=2πr²+2πrh,V=πr²h。圆锥V=1/3×πr²h。等底等高：V柱=3V锥。注意r是半径不是直径。"
      ,
        "transfer": "圆柱与圆锥→五年级长方体和正方体（体积=底面积×高的推广）→初中球体（V=4/3πr³）→高中立体几何。"
      ,
        "advanced": "圆柱与圆锥侧面展开图、斜截面圆柱的体积（卡瓦列里原理）、球与圆柱的关系（阿基米德墓碑：V球:V柱=2:3）、旋转体体积。"
      }
,
  {
        "id": "ENG-06-010",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是忘了时态规则，而是没发现题目里的\"时间信号词\"。先试试：在题目里圈出yesterday/tomorrow/every day/now这些词——它们直接告诉你用什么时态。yesterday=过去时，像时钟一样准。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·识别时态信号词：圈出时间状语。yesterday→一般过去时，every day→一般现在时，tomorrow→一般将来时，now→现在进行时。",
            "第2步·确定动词形式：一般过去时→动词+ed或不规则变化(go→went)。现在进行时→am/is/are+动词ing。一般将来时→will+动词原形。",
            "第3步·检查主谓一致：第三人称单数(he/she/it)→一般现在时动词+s/es。They walk→He walks。注意and连接两个主语用复数。",
            "第4步·造句自检：用学到的语法规则造3个句子→用不同人称各造一个(I/He/They)→读一遍看是否通顺→对照语法规则检查。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "一般现在时第三人称忘加s",
                "fix": "He go→He goes。只要主语是he/she/it，一般现在时动词必加s/es"
              },
              {
                "type": "现在进行时缺be动词",
                "fix": "She reading→She is reading。现在进行时=be+动词ing，缺be不成句"
              },
              {
                "type": "不规则动词过去式记错",
                "fix": "go→went(不是goed)，eat→ate(不是eated)。不规则动词表要反复记忆"
              }
            ]
      ,
        "oneLineModel": "英语时态=时间信号词→动词变形式。三单现+s，过去+ed/went，进行be+ing，将来will+原形。"
      ,
        "transfer": "6年级时态→7年级更多时态(完成时)→初中时态综合对比→高中虚拟语气。"
      ,
        "advanced": "时态的呼应（主从句时态一致）、进行时的特殊用法（表将来）、完成时的延续性用法。"
      }
,
  {
        "id": "MATH-05-006",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会除法，而是除数是小数时不知道该移几位小数点。先试试：4.68÷1.2，看除数1.2有1位小数→需要右移1位变12，被除数4.68也要右移1位变46.8。两边做的操作必须一模一样——就像跷跷板，你动一边，另一边也得动同样的量。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·除数转化：除数是小数时，除数×10ⁿ变整数，被除数同步×10ⁿ。4.68÷1.2→除数右移1位变12，被除数右移1位变46.8→46.8÷12。",
            "第2步·按整数除法计算：46÷12商3余10，落8→108÷12=9。商的小数点与被除数对齐→3.9。",
            "第3步·除不尽时处理：22÷7=3.142857…，发现余数重复→标记循环节。22÷7=3.1̇42857̇（循环节6位）。用计算器验证：22÷7=3.142857142857…。",
            "第4步·求商的近似数：保留两位小数看第三位。22÷7≈3.14（第三位2<5→舍），保留一位≈3.1。标注\"≈\"号。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "被除数小于除数时忘记商0",
                "description": "1.2÷5中1<5，整数部分商0→0.24，孩子忘记商0直接写.24。",
                "fix": "被除数整数部分不够除时必须商0占位，然后点小数点继续。"
              },
              {
                "type": "循环节判断不准确",
                "description": "11÷6=1.8333…误写成1.83̇（只有3循环），实际是1.83̇（3循环）。",
                "fix": "一直除到余数出现2次以上的重复，再确定循环节从哪一位开始。1.8333…第一次余数5→第二次余数5→循环节确定。"
              },
              {
                "type": "近似数忘写≈",
                "description": "22÷7≈3.14直接写成22÷7=3.14，混淆精确值和近似值。",
                "fix": "≈读作\"约等于\"，≠读作\"不等于\"。除不尽用≈，能除尽用=。"
              }
            ]
      ,
        "oneLineModel": "小数除法=除数化整→被除数同步移→按整数除→商的小数点对齐→除不尽补0继续→判断循环或求近似数。"
      ,
        "transfer": "小数除法→五年级简易方程（解方程中的除法）→六年级分数除法（除以一个数=乘倒数）→初中实数运算。"
      ,
        "advanced": "循环小数化分数（0.3̇=1/3，0.14̇2857̇=1/7）、纯循环与混循环的区别、连分数表示法、计算器中的科学计数模式。"
      }
,
  {
        "id": "MATH-06-006",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会取倒数，而是把被除数也倒过来了。先试试：3/4÷2/3，把÷号圈起来变成×，只把÷号后面的2/3倒过来变成3/2→3/4×3/2=9/8。前面的3/4不变！",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·倒数准备：求除数的倒数。2/3的倒数=3/2，5的倒数=1/5，1又1/2=3/2→倒数=2/3。",
            "第2步·除变乘+倒数：3/4÷2/3=3/4×3/2=9/8=1又1/8。6÷3/4=6×4/3=24/3=8。注意：只把除数取倒数，被除数不变。",
            "第3步·混合运算按顺序：有括号先算括号，再算乘除。3/4÷(2/3×1/2)=3/4÷(1/3)=3/4×3/1=9/4=2又1/4。",
            "第4步·已知部分求整体：\"一个数的2/3是12\"→设x→(2/3)x=12→x=12÷(2/3)=12×3/2=18。画线段图验证：18分3份每份6，2份=12。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "被除数也跟着取倒数",
                "description": "3/4÷2/3→4/3×3/2=2（错误，把被除数也倒过来了）。",
                "fix": "只有除数（÷号后面的数）取倒数。被除数不变。口诀：÷变×，后面的数倒过来。"
              },
              {
                "type": "整数除分数直接乘分母",
                "description": "6÷3/4=6×3/4=18/4=4.5（忘记取倒数）。正确：6×4/3=8。",
                "fix": "整数÷分数=整数×除数的倒数。6÷3/4=6×4/3。"
              },
              {
                "type": "连续除以分数跳步",
                "description": "12÷3/4÷2/3→12×4/3×3/2=24。孩子写成12÷(3/4×2/3)=12÷(1/2)=24（虽然结果一样但不是通用方法）。",
                "fix": "从左到右：12÷3/4=12×4/3=16→16÷2/3=16×3/2=24。"
              }
            ]
      ,
        "oneLineModel": "分数除法=乘除数的倒数。÷变×，除数分子分母交换。已知部分求整体用除法。"
      ,
        "transfer": "分数除法→六年级比和比例（解比例用交叉相乘=分数除法）→六年级列方程解应用题→初中分式方程。"
      ,
        "advanced": "繁分数（A/(B/C)=A×C/B）、连分数与黄金分割、工程问题中的分数除法（1÷效率=时间）。"
      }
,
  {
        "id": "ENG-06-009",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算180°减两角，而是三边关系判断时忘了\"严格大于\"。先试试：拿3根小棒，3cm/4cm/8cm→拼三角形→3+4=7<8→拼不起来，有缺口。而5cm/7cm/10cm→5+7=12>10→能拼出完整的三角形。亲自试一试就明白了。",
              "interactionType": "dynamic-question"
            },
        "chip": {
              "script": "除数是小数的除法，核心一招：把除数变成整数！除数小数点向右移几位，被除数也移几位，然后就变成普通的整数除法了。",
  ...
  ,
        "solveSteps": [
            "第1步·内角和=180°：任意三角形∠A+∠B+∠C=180°。已知两角求第三角→180°-已知两角。顶角40°等腰三角→底角=(180°-40°)/2=70°。",
            "第2步·判断能否构成三角形：两边之和>第三边。3cm/4cm/8cm→3+4=7<8→不能构成。5cm/7cm/10cm→5+7=12>10✓。",
            "第3步·第三边取值范围：已知两边a和b→|a-b|<第三边<a+b。两边5和8→3<第三边<13。",
            "第4步·按角分类+按边分类结合：一个三角形如果是直角三角形，能否是等腰？能！等腰直角三角形：90°+45°+45°，两直角边相等。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "三角形内角和精确180°",
                "fix": "量角器量的和可能是179°或181°→测量误差。理论上严格=180°"
              },
              {
                "type": "三边关系漏等于",
                "fix": "两边之和=第三边→退化成线段，不能构成三角形。必须是严格>"
              },
              {
                "type": "第三边范围两端忘严格不等",
                "fix": "5和8之间第三边>3且<13，取不到3和13。能取4~12之间的整数"
              }
            ]
      ,
        "oneLineModel": "三角形：内角和=180°，两边之和>第三边，|差|<第三边<和。分类：按角(锐/直/钝)+按边(等边/等腰/不等边)。"
      ,
        "transfer": "三角形→四年级角的度量→五年级多边形内角和(n-2)×180°→六年级圆→初中全等/相似→高中三角函数。"
      ,
        "advanced": "三角形外角定理、三角形中的欧拉线、拿破仑定理、莫莱三角形三分角定理、三角形的五心。"
      }
,
  {
        "id": "MATH-06-018",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会除法，而是把\"甲6天乙8天\"直接加成了14天。先试试：把工作总量想成1个蛋糕。甲6天吃完→每天吃1/6个。乙8天吃完→每天吃1/8个。两人一起吃→每天吃1/6+1/8=7/24个。吃完整个蛋糕需要1÷(7/24)=24/7天。时间不能直接加！",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解三个量关系：工作总量=工作效率×工作时间。效率=1÷单独完成时间（把总量看作\"1\"）。甲单独完成需6天→甲效率=1/6。",
            "第2步·设总量为1：总工作量=1。甲效率1/6，乙效率1/8→合作效率=1/6+1/8=4/24+3/24=7/24。合作完成时间=1÷(7/24)=24/7≈3.43天。",
            "第3步·部分合作问题：甲先做2天→完成2×1/6=1/3→剩余2/3。甲乙合作→时间=(2/3)÷(7/24)=(2/3)×(24/7)=48/21=16/7≈2.29天。总时间=2+2.29=4.29天。",
            "第4步·水管注水问题（类工程问题）：进水管效率+，出水管效率-。进水管1/3+1/4，出水管-1/6→净效率=1/3+1/4-1/6=4/12+3/12-2/12=5/12。注满=1÷(5/12)=12/5=2.4小时。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "没有把总量设为1",
                "description": "用具体数字当总量（如把工作量设为6和8的最小公倍数24）。虽然也能算但容易搞混。",
                "fix": "统一设总量=1，效率=1÷完成时间。好处是公式统一：时间=总量÷效率和。"
              },
              {
                "type": "合作效率加错",
                "description": "甲6天乙8天→合作时间=6+8=14天（错误，把时间相加了）。",
                "fix": "效率=1÷时间，效率才能相加。合作时间=1÷(效率和)，不是时间相加。"
              },
              {
                "type": "间歇工作问题算错",
                "description": "甲做2天休息1天→实际工作效率要除以3再乘2（2/3的有效时间）。",
                "fix": "分清\"单独完成需x天\"（连续工作）和\"实际工作中每y天休z天\"的区别。"
              }
            ]
      ,
        "oneLineModel": "工程问题：总量=1，效率=1÷完成时间，合作效率=各效率之和，合作时间=1÷合作效率。"
      ,
        "transfer": "工程问题→六年级行程问题（效率→速度）→六年级浓度问题→初中工作效率问题→高中导数（瞬时变化率）。"
      ,
        "advanced": "交替工作问题（甲1天乙1天轮流）、多人多阶段工程问题、牛吃草问题（草在生长=出水管）、变速工程问题。"
      }
,
  {
        "id": "MATH-05-021",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算倒数，而是不知道什么时候该用除法。先试试：\"一个数的3/5是15\"——如果你设这个数是x，那x的3/5=15，即(3/5)x=15，x=? 这就是除法：已知部分和占比求整体，永远用除法。",
              "interactionType": "dynamic-question"
            },
        "chip": {
              "script": "分数除法一句话：除以一个数等于乘以它的倒数！把÷变成×，把除数倒过来，剩下的就是分数乘法。",
  ...
  ,
        "solveSteps": [
            "第1步·理解倒数：乘积为1的两个数互为倒数。3/4的倒数=4/3（分子分母交换），5的倒数=1/5，0没有倒数。倒数≠相反数（-3的相反数是3，倒数是-1/3）。",
            "第2步·分数除以整数：除以一个整数=乘它的倒数。3/4÷2=3/4×1/2=3/8。画图验证：把3/4的蛋糕平均分2份，每份是3/8。",
            "第3步·一个数除以分数：除以一个分数=乘它的倒数。6÷2/3=6×3/2=9。理解：6里面包含几个2/3？每个2/3对应1.5，6÷(2/3)=9个2/3。",
            "第4步·已知一个数的几分之几求原数：用除法。一个数的3/5是15→15÷3/5=15×5/3=25。验证：25的3/5=25×3/5=15✓。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "除以分数时忘记取倒数",
                "description": "6÷2/3=6×2/3=4（忘记把除数倒过来）。正确：6÷2/3=6×3/2=9。",
                "fix": "口诀：除以一个分数=乘它的倒数。把÷变×，把除数的分子分母交换。"
              },
              {
                "type": "倒数取错",
                "description": "2又1/3的倒数→先化假分数7/3→倒数3/7。孩子直接写成1又2/3。",
                "fix": "带分数先化假分数再取倒数。含整数也一样：5=5/1→倒数1/5。"
              },
              {
                "type": "\"已知一个数的几分之几\"用乘法",
                "description": "\"一个数的3/5是15，这个数是多少\"→15×3/5=9（错误）。正确：15÷3/5=25。",
                "fix": "方程法：设这个数为x→(3/5)x=15→x=15÷(3/5)=15×5/3=25。"
              }
            ]
      ,
        "oneLineModel": "分数除法=乘除数的倒数。除以整数=乘1/整数，除以分数=分子分母交换后相乘。已知部分求整体用除法。"
      ,
        "transfer": "分数除法→六年级比（比的前项÷后项=比值）→六年级百分数应用题→初中分式方程。"
      ,
        "advanced": "繁分数化简（分母或分子含分数）、连除问题（除以多个分数=连续乘倒数）、单位分数拆分在除法中的应用。"
      }
,
  {
        "id": "MATH-06-017",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会列算式，而是搞不清这是相遇还是追及。先试试：画两个小人的位置——如果两人面对面走→相遇问题用速度和；如果一前一后同方向→追及问题用速度差。画图的那一刻，答案就出来了。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·判断行程类型：相遇→总路程=速度和×时间；追及→路程差=速度差×时间；环形→考虑圈数。\"甲乙从A、B两地同时相向而行\"→相遇问题。",
            "第2步·画线段图：标出A、B两点和总路程。甲从A出发速度60km/h，乙从B出发速度40km/h，相距300km。相向而行箭头相对。",
            "第3步·列方程：设t小时后相遇→60t+40t=300→100t=300→t=3小时。追及：甲先走2小时行120km，乙从A追速度80km/h→120+60t=80t→120=20t→t=6小时追上。",
            "第4步·验证：相遇3h→甲行180km乙行120km→180+120=300✓。追及6h→甲共行60×(2+6)=480km，乙行80×6=480km→位置相同✓。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "相遇与追及公式搞混",
                "description": "追及问题用了速度和（应为速度差）。",
                "fix": "相遇=面对面→速度叠加（和）；追及=同向而行→速度差决定追上时间。"
              },
              {
                "type": "忽略先行时间",
                "description": "\"甲先行2小时\"→甲已走60×2=120km，追及路程=120km+后续甲走的路程。",
                "fix": "先行时间×速度=已行路程。追及时快的不仅要追上这个已行路程，还要追上继续走的路程。"
              },
              {
                "type": "环形跑道忘算圈数",
                "description": "环形跑道追及：快的比慢的多跑1圈时追上。只算到两人路程相等就停了（那是迎面相遇不是追及）。",
                "fix": "环形追及=快者路程-慢者路程=1圈长度。设t小时后→(v快-v慢)×t=一圈。"
              }
            ]
      ,
        "oneLineModel": "相遇：总路程=(v₁+v₂)×t。追及：路程差=(v快-v慢)×t。环形追及：快比慢多跑一圈。"
      ,
        "transfer": "行程问题→六年级工程问题（效率类比速度）→六年级流水行船→初中一元一次方程（匀速运动）→高中物理运动学。"
      ,
        "advanced": "相对速度（顺风逆风、顺水逆水）、多次相遇与追及、变速问题、ST图（路程-时间图像）分析。"
      }
,
  {
        "id": "MATH-06-019",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算百分数，而是没搞清\"加水后什么不变\"。先试试：一杯5%的盐水，往里面加水——盐的量变了吗？没有！变的只是总重量。抓住\"盐不变\"这个不变量，稀释问题就解了。浓缩问题同理：水不变。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解浓度：浓度=溶质÷溶液×100%。盐水浓度=盐÷(盐+水)×100%。200g盐水含盐10g→浓度=10÷200=5%。",
            "第2步·稀释问题（加水降低浓度）：5%盐水300g→盐=300×5%=15g。加水后浓度变3%→溶液总量=15÷3%=500g→加水500-300=200g。盐不变是关键。",
            "第3步·浓缩问题（加盐提高浓度）：5%盐水300g→水=300-15=285g。加盐后浓度变10%→水不变→285=新溶液×(1-10%)→新溶液=285÷0.9≈316.7g→加盐=316.7-300≈16.7g。",
            "第4步·混合问题：5%盐水200g与10%盐水300g混合→总盐=200×5%+300×10%=10+30=40g→总溶液=500g→浓度=40÷500=8%。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "浓度公式搞反",
                "description": "浓度=溶液÷溶质（错误）。5%的盐水→盐=5g，盐水=100g。",
                "fix": "浓度=溶质÷溶液。溶质=被溶解的物质(盐)，溶液=溶质+溶剂(盐水)。溶质<溶液→浓度<100%。"
              },
              {
                "type": "加水时忘记盐不变",
                "description": "稀释时用总溶液×新浓度求新盐量，忘记盐量不变。",
                "fix": "加水稀释=加水→盐质量不变。先算出原有盐量，再用新浓度反推新溶液总量。"
              },
              {
                "type": "混合浓度取平均",
                "description": "5%和10%等质量混合浓度=(5%+10%)÷2=7.5%（这只在等质量时才对）。",
                "fix": "不等质量必须用加权平均：(m₁×c₁+m₂×c₂)÷(m₁+m₂)。不是简单算术平均。"
              }
            ]
      ,
        "oneLineModel": "浓度=溶质÷溶液×100%。稀释：盐不变→新溶液=盐÷新浓度。浓缩：水不变→新溶液=水÷(1-新浓度)。混合：加权平均。"
      ,
        "transfer": "浓度问题→六年级百分数应用→六年级比例→初中化学溶液配制→高中物质的量浓度。"
      ,
        "advanced": "多次稀释/浓缩问题、十字交叉法（快速求混合浓度）、饱和溶液与溶解度、蒸发与结晶。"
      }
,
  {
        "id": "CHI-04-010",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会写字，而是不知道写什么。先试试：闭上眼睛想一个和题目有关的画面——你看到了什么？听到了什么？心里什么感觉？把这个画面用文字画出来，就是最好的作文。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·审题圈关键词：圈出题目的限定词。\"我的妈妈\"→限定=妈妈(不是爸爸)、\"我的\"(第一人称)、记叙文。",
            "第2步·列提纲：开头(1段引入)→中间(2-3段详情，每段一个方面)→结尾(1段点题升华)。用关键词代替完整句子。",
            "第3步·写具体：用\"五感法\"（看到的/听到的/闻到的/摸到的/心里想的）代替空洞形容词。不是\"妈妈很好\"而是\"妈妈深夜还在灯下为我缝校服\"。",
            "第4步·修改润色：默读一遍→检查错别字和病句→看开头是否吸引人→看结尾是否点题→加上一个好词好句。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "偏题跑题",
                "fix": "每写完一段对照题目自问\"这段在写题目要求的内容吗\"。发现跑题立即拉回"
              },
              {
                "type": "流水账没有重点",
                "fix": "选1-2件最典型的事详写，其他一笔带过。不是所有事情都值得写"
              },
              {
                "type": "结尾草率",
                "fix": "结尾=回顾开头+表达感受+升华主题。不是\"真开心\"就完了"
              }
            ]
      ,
        "oneLineModel": "作文=审题→选材→提纲→描写→点题。好作文=真情实感+具体细节+结构完整。"
      ,
        "transfer": "4年级作文→5年级字数增加/文体扩展→初中记叙文/议论文。"
      ,
        "advanced": "倒叙/插叙手法、环境描写的烘托作用、作文六要素的灵活运用、仿写与创新。"
      }
,
  {
        "id": "MATH-05-009",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会背公式，而是找不到正确的\"高\"在哪里。先试试：在三角形ABC中，以BC为底，用三角板的直角边从顶点A画一条垂直于BC的线段——这条垂直线段的长就是高。如果垂足在BC的延长线上也不用怕，高可以是\"在外面的\"。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·确认图形并回忆公式：平行四边形=底×高，三角形=底×高÷2，梯形=(上底+下底)×高÷2。例如平行四边形底8cm高5cm→面积=8×5=40cm²。",
            "第2步·找对应数据：高是从顶点向对边作的垂直线段。三角形底10cm高6cm→注意高不一定在图形内部（钝角三角形的高在外部延长线上）。",
            "第3步·组合图形分割：将L形拆成2个长方形分别计算面积再相加。或补全成一个大长方形再减去多算的部分。例如：一个长10宽8的长方形缺了一个4×3的角→面积=10×8-4×3=80-12=68。",
            "第4步·带单位验证：所有长度单位必须一致才能代入公式。单位不一致的先换算。验证：面积单位=长度单位²（cm×cm=cm²）。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "三角形忘÷2",
                "description": "底10cm高6cm的三角形面积算成10×6=60cm²，忘记÷2。",
                "fix": "三角形是平行四边形的一半，永远记得÷2。画一个同样的三角形拼成平行四边形来验证。"
              },
              {
                "type": "底和高不对应",
                "description": "梯形中拿一条腰当高。梯形的腰不一定是高，高必须是上底和下底之间的垂直距离。",
                "fix": "高=上底和下底之间的垂直线段。在图上画一条垂直虚线连接上下底，这条虚线的长度才叫高。"
              },
              {
                "type": "单位不统一直接算",
                "description": "底8dm高5cm，直接8×5=40，忘了1dm=10cm。",
                "fix": "先统一单位：8dm=80cm→面积=80×5÷2=200cm²或80×5=400cm²(平行四边形)。"
              }
            ]
      ,
        "oneLineModel": "平行四边形=底×高，三角形=底×高÷2，梯形=(上底+下底)×高÷2。高必须是垂直线段，单位要统一。"
      ,
        "transfer": "多边形面积→五年级组合图形面积→五年级长方体和正方体（表面积=所有面面积之和）→六年级圆面积→初中勾股定理。"
      ,
        "advanced": "等积变形（同底等高面积相等）、一半模型（三角形面积=平行四边形一半）、燕尾模型与风筝模型、格点面积公式（皮克定理）。"
      }
,
  {
        "id": "MATH-05-014",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会背公式，而是分不清什么时候用表面积、什么时候用体积。先试试：如果一个问题是\"需要多少包装纸\"——那是包在外面，用的是表面积；如果是\"能装多少水\"——那是装在里面，用的是体积。分清\"外包\"和\"内装\"就不乱了。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·识别顶点棱面：长方体有8个顶点、12条棱（4长+4宽+4高）、6个面（3组对面全等）。正方体是特殊长方体（长=宽=高），12条棱全等。",
            "第2步·算表面积：长方体表面积=2×(长×宽+长×高+宽×高)。例如长5cm宽3cm高4cm→S=2×(5×3+5×4+3×4)=2×(15+20+12)=2×47=94cm²。正方体S=6×棱长²。",
            "第3步·算体积：长方体体积=长×宽×高=5×3×4=60cm³。正方体V=棱长³。容积=内部空间大小，计算方法相同，单位用mL或L(1L=1000mL=1000cm³)。",
            "第4步·展开图验证：把长方体剪开摊平，画出6个面的展开图。验证：展开图中对面不相邻，各面尺寸与长宽高对应。正方体有11种展开图。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "表面积和体积公式混淆",
                "description": "把表面积公式当成体积用（长×宽×高算表面积），或体积=6×棱长²（表面积公式）。",
                "fix": "表面积=外皮面积（单位²），体积=内部空间（单位³）。用手摸一摸：摸到的是表面积，装水的是体积。"
              },
              {
                "type": "求无盖箱子的表面积时照搬公式",
                "description": "给一个无盖鱼缸算表面积，仍用2×(长×宽+长×高+宽×高)，多算了一个长×宽。",
                "fix": "无盖=少一个面（通常是上面）。表面积=5个面之和=长×宽+2×长×高+2×宽×高。"
              },
              {
                "type": "单位换算在体积中搞错",
                "description": "1m³=100cm³（错误），正确是1m³=1000000cm³（100³）。",
                "fix": "1m=100cm→1m³=100×100×100=1000000cm³。体积单位进率=长度单位进率的立方。"
              }
            ]
      ,
        "oneLineModel": "长方体：V=长×宽×高，S=2(ab+ah+bh)。正方体：V=a³，S=6a²。对面相同，体积进率=长度进率³。"
      ,
        "transfer": "长方体和正方体→五年级体积单位进率→六年级圆柱体积（V=πr²h→底面积×高的推广）→初中立体几何。"
      ,
        "advanced": "长方体对角线的长度（√(a²+b²+c²)）、表面积一定时体积最大化问题（正方体最优）、欧拉公式（顶点+面-棱=2）、切补问题（一刀增加2个面）。"
      }
,
  {
        "id": "CHI-05-012",
  ...
  ,
      ...
      ,
        "oneLineModel": "作文=审题→选材→提纲→描写→点题。好作文=真情实感+具体细节+结构完整。"
      ,
        "transfer": "5年级作文→6年级字数增加/文体扩展→初中记叙文/议论文。"
      ,
        "advanced": "倒叙/插叙手法、环境描写的烘托作用、作文六要素的灵活运用、仿写与创新。"
      }
,
  ...
  ,
      ...
      ,
        "oneLineModel": "英语=词汇+语法+技能(听说读写)。多听→会读，多说→会写，多练→会用。"
      ,
        "transfer": "5年级英语→6年级能力提升→初中英语综合→高中英语进阶。"
      ,
        "advanced": "英语学习策略（可理解输入假说）、语感的科学培养、二语习得关键期理论。"
      }
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会交叉相乘，而是判断正反比例时只看\"一个变大另一个也变大\"。先试试：列出几组x和y的值，算一算y÷x是不是常数（正比例），或x×y是不是常数（反比例）。只有比值或积不变才叫比例关系。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解比例：表示两个比相等的式子。a:b=c:d⇔a/b=c/d。内项积=外项积：a×d=b×c。例如3:4=6:8→3×8=4×6=24✓。",
            "第2步·解比例用交叉相乘：3:x=6:10→3×10=6×x→30=6x→x=5。比例尺=图上距离:实际距离=1:10000→图上3cm→实际3×10000=30000cm=300m。",
            "第3步·正比例判断：两种量比值一定（y/x=k常数）。速度一定时，路程和时间成正比例。表：时间1h→40km，2h→80km，比值40不变。图像是过原点的直线。",
            "第4步·反比例判断：两种量积一定（xy=k常数）。路程一定时，速度和时间成反比例。速度40km/h→3h，80km/h→1.5h，积120不变。图像是双曲线。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "正反比例判断只看增减方向",
                "description": "y随x增大而增大→一定是正比例（错误，如y=x²也是增大但不成正比）。",
                "fix": "正比例必须比值一定(y/x=k)，反比例必须积一定(xy=k)。不能只看增减方向。"
              },
              {
                "type": "解比例的交叉相乘方向搞反",
                "description": "3:x=6:10→3×6=x×10（错误）。正确是外项×外项=内项×内项：3和10是外项，x和6是内项→3×10=x×6。",
                "fix": "交叉相乘=左上×右下=右上×左下。画叉号连一对：3↘10，x↙6→3×10=x×6。"
              },
              {
                "type": "反比例函数图像误认为直线",
                "description": "反比例的图是曲线，孩子画成向下倾斜的直线。",
                "fix": "取3-4个x值算y值描点，连线时看趋势。正比例→直线过原点，反比例→曲线。实际描点验证。"
              }
            ]
      ,
        "oneLineModel": "比例=两个比相等，a:b=c:d⇔ad=bc。正比例：y/x=k(一定)，反比例：xy=k(一定)。"
      ,
        "transfer": "比例→六年级比例尺→六年级用比例解应用题→初中一次函数(y=kx正比例)和反比例函数(y=k/x)→高中解析几何。"
      ,
        "advanced": "比例在相似三角形中的应用、黄金分割比(0.618)、调和比例、十字交叉法解混合问题。"
      }
,
  {
        "id": "MATH-06-015",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会解方程，而是找不到等量关系来列方程。先试试：在题目中把所有数都圈出来，然后找\"一共\"\"相差\"\"剩下\"这些词——它们就是等号的位置。比如\"两人共45本\"→小明+小华=45，这就是你的方程！",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·审题找等量关系：读题圈出\"是…的几倍\"\"比…多/少\"\"一共\"\"还剩\"等关键词。\"小明有x本书，小华是他的2倍多3本，两人共45本\"→关键：两人共45本→小明的+小华的=45。",
            "第2步·设未知数：一般设问题所求为x，或设单位\"1\"的量为x。\"小红比小明的3倍少5本\"→设小明为x本，小红=3x-5本。",
            "第3步·列方程：根据等量关系写等式。x+(3x-5)=45→4x-5=45→4x=50→x=12.5。检验：小明12.5本不合实际→说明设错或读错。重新审题。",
            "第4步·检验并作答：把x值代入每个条件验证。小明12本→小华=2×12+3=27→共39≠45→重新设。若小明10本→小华23→共33→仍不对。直到小明10.5？检查题目是否有\"多3本共45本\"→x+(2x+3)=45→3x=42→x=14→小华=31→14+31=45✓。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "等量关系找错",
                "description": "\"小华的2倍多3本\"→孩子列x×2+3=y但没关联总量45本。",
                "fix": "先把所有数量关系写在草稿纸上，再用\"总量=各部分和\"这把锁把所有量锁在一起。"
              },
              {
                "type": "设未知数不合理导致方程复杂",
                "description": "设小华x本→小明=(x-3)÷2→方程变复杂。",
                "fix": "谁和问题直接相关就设谁为x。一般设比较的基准量（\"小明\"）为x。"
              },
              {
                "type": "检验时不算全",
                "description": "x=14代回发现小华=31，但没检验31是否是\"2倍多3本\"（14×2+3=31✓）且总数=45。",
                "fix": "检验三个点：①小华=2×小明+3？②总数=45？③答案符合实际？"
              }
            ]
      ,
        "oneLineModel": "列方程=找等量关系→设基准量为x→用x表达其他量→根据等量关系列等式→解方程→多条件检验。"
      ,
        "transfer": "列方程解应用题→六年级比例应用题→初中一元一次方程应用题→初二二元一次方程组→初三二次方程。"
      ,
        "advanced": "用方程解行程问题、工程问题、浓度问题等复杂应用题、设而不求的技巧、方程的变形与同解。"
      }
,
  {
        "id": "MATH-06-021",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会解方程，而是\"比…多\"\"是…的几倍\"这些关系翻译成方程时方向反了。先试试：\"甲比乙多5\"→甲-乙=5→甲=乙+5。用数字验证：乙=10，甲=15→15比10多5✓。确认了关系再设未知数。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·逐句翻译为代数式：\"甲比乙的3倍多5\"→设乙=x，甲=3x+5。\"甲和乙共85\"→方程：x+(3x+5)=85。\"甲比乙的一半少3\"→甲=x/2-3。",
            "第2步·用表格法整理信息：列表格 | 人物 | 关系 | 数量 | → 小明 | x |  | 小华 | 2x+3 |  | 合计 | 3x+3=45 |。表格让关系一目了然。",
            "第3步·直接设与间接设：\"小明比小华多15本，小华是小明的2/3\"→直接设小明=x，小华=2x/3→x-2x/3=15→x/3=15→x=45。间接设：设小华=2x，小明=3x（避开分数）。",
            "第4步·多条件逐一验证：把解代入每一个条件。\"小华=2×小明+3\"→2×14+3=31✓。\"共45\"→14+31=45✓。\"小明比小华少\"→14<31✓。三个条件全满足。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "\"多\"和\"少\"方向搞反",
                "description": "\"甲比乙多5\"→方程写成x+5=y（甲多5）还是x=y+5（乙多5）？",
                "fix": "\"甲比乙多5\"=甲-乙=5→甲=乙+5。检验：甲大乙小，+5才对。"
              },
              {
                "type": "间接设未知数但忘还原",
                "description": "设小华=2x解出x=10，直接写小华=10（应为20）。",
                "fix": "设了什么就是什么。如果设的中间变量，最后一定要根据关系换算回原始问题所求的量。"
              },
              {
                "type": "只有方程没有检验",
                "description": "解出x后不代回原题验证，导致\"小明105岁\"这种荒谬答案也能过。",
                "fix": "解完必检验：代回每个条件→是否都满足→答案是否符合实际（人数应为正整数等）。"
              }
            ]
      ,
        "oneLineModel": "列方程=逐句翻译+表格整理+设准未知数+多条件检验。设基准量为x，其他量用x表达。"
      ,
        "transfer": "列方程解应用题→初中一元一次方程→二元一次方程组→一元二次方程→函数建模。"
      ,
        "advanced": "间接设未知数的技巧、设而不求（辅助未知数）、含参数的方程讨论、方程与不等式的结合。"
      }
,
  {
        "id": "CHI-06-006",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不认识字，而是读完文章后不知道答案藏在哪里。先试试：把题目中的关键词圈出来（如\"为什么XX要这样做\"），然后回到文章里找这个词第一次出现的地方——答案往往就在那附近，前后各读3句话。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·通读全文：快速浏览文章，圈出不认识的字词，标注自然段。不看题目先读一遍，把握文章大意。",
            "第2步·逐段精读：每读完一段问自己\"这段讲了什么\"→用一句话概括段意写在旁边。关键句往往在段首或段尾。",
            "第3步·审题定位：读题目→找到题目中的关键词→回到文中定位对应段落→精读该段落找答案。注意\"联系上下文\"类题目要读前后各一段。",
            "第4步·规范作答：答案要完整句子，引用原文关键词。\"为什么\"类先写\"因为...\"，\"说明什么\"类先写\"说明了...\"。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "不看文章直接做题",
                "fix": "必须先通读全文至少一遍。题目都基于文章内容，不读文章=瞎猜"
              },
              {
                "type": "主观臆断不找原文依据",
                "fix": "每道题的答案必须在原文中找到对应的句子或段落作为依据"
              },
              {
                "type": "概括题答得太啰嗦或太简单",
                "fix": "概括=谁+做了什么+结果怎样。控制在20字以内"
              }
            ]
      ,
        "oneLineModel": "阅读理解=通读→定位→分析→作答。答案在文中，概括要精炼。"
      ,
        "transfer": "6年级阅读→7年级阅读深度提升→初中现代文/文言文阅读体系。"
      ,
        "advanced": "文本结构分析（总分/并列/递进）、修辞手法赏析、作者意图与读者反应的互动。"
      }
,
  {
        "id": "CHI-06-012",
  ...
  ,
      ...
      ,
        "oneLineModel": "作文=审题→选材→提纲→描写→点题。好作文=真情实感+具体细节+结构完整。"
      ,
        "transfer": "6年级作文→7年级字数增加/文体扩展→初中记叙文/议论文。"
      ,
        "advanced": "倒叙/插叙手法、环境描写的烘托作用、作文六要素的灵活运用、仿写与创新。"
      }
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不懂某个知识点，而是综合题里不同知识点混在一起分不清。先试试：用三种颜色的笔——红色圈\"计算\"相关(运算律/顺序)，蓝色圈\"图形\"相关(三角形/角度)，绿色圈\"统计\"相关(条形图/平均数)。分类击破。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·知识网：四则运算→运算定律→小数→三角形→图形的运动→条形统计图→平均数。每个模块列出3个最易错点。",
            "第2步·综合计算：125×32×25→拆32=8×4→(125×8)×(4×25)=1000×100=100000。99×57+57=57×(99+1)=5700。",
            "第3步·图形综合题：等腰三角形顶角80°→底角=(180-80)/2=50°。已知三角形两边3cm和5cm→第三边范围：2<x<8。",
            "第4步·统计与平均数：六次数学成绩92/88/96/90/94/86→总和=546→平均数=546/6=91。去掉最低86后平均=(546-86)/5=92。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "运算律不会综合运用",
                "fix": "先扫描数字→找凑整对(25+4/125+8)→选定律→算。一题可能用到多个定律"
              },
              {
                "type": "三角形两边之差<第三边<两边之和",
                "fix": "两边3和5→第三边>5-3=2且<5+3=8→范围(2,8)"
              },
              {
                "type": "平均数去掉极值问题",
                "fix": "去掉一个最高/最低→总和变→份数变→平均数变。按新条件重新算"
              }
            ]
      ,
        "oneLineModel": "四下总复习=运算(定律+小数)+图形(三角形+运动)+统计(条形图+平均数)。重运算律应用和三角形性质。"
      ,
        "transfer": "四下→五上(小数乘除法+方程+多边形面积)→小初衔接准备。"
      ,
        "advanced": "简易方程启蒙（用字母表示数的思想）、数学建模思想培养（从生活问题到数学问题）。"
      }
,
  {
        "id": "ENG-05-011",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会除法，而是没有先判断\"种树的类型\"。先试试：在纸上画一条线段代表路，在两端各画一个点代表树，中间按间距画点——数一数有几个点几段？点和段的关系就是你要找的公式。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·判断植树类型：两端都种→棵数=段数+1（如一条路从头种到尾）；一端种→棵数=段数（如从门口开始种到墙边）；两端不种→棵数=段数-1（如两栋楼之间种树）；环形→棵数=段数（如池塘一圈）。",
            "第2步·算段数：总长度÷间隔=段数。一条路长100米，每隔5米种一棵→段数=100÷5=20段。",
            "第3步·根据类型算棵数：两端都种→20+1=21棵；一端种→20棵；两端不种→20-1=19棵；环形→20棵。",
            "第4步·反向验证：已知21棵树、间距5米→(21-1)×5=100米（两端都种），与题目总长一致。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "不判断类型直接+1",
                "description": "所有植树问题都两端种→棵数=段数+1。环形种树也+1导致多一棵。",
                "fix": "画简易图：用5个点表示树，中间4段。两端都有点=5树4段→+1；只有一端有点=4树4段→不+不-。"
              },
              {
                "type": "总长÷间距算错段数",
                "description": "100米每隔5米→20段，孩子算成100÷5=20棵（把段数当棵数）。",
                "fix": "段数=间隔数≠棵数。先用除法求段数，再根据类型±1求棵数。"
              },
              {
                "type": "环形与直线混淆",
                "description": "环形种树首尾相连，棵数=段数。孩子按两端都种+1。",
                "fix": "环形没有\"两端\"，起点和终点是同一棵树。画一圈点验证：5棵树把圆圈分成5段→棵数=段数。"
              }
            ]
      ,
        "oneLineModel": "植树问题：总长÷间距=段数，两端都种+1、一端种不变、两端不种-1、环形不变。"
      ,
        "transfer": "植树问题→五年级爬楼梯问题（楼层=台阶数+1）→五年级锯木头问题（锯的次数=段数-1）→六年级时钟问题（敲钟间隔）。"
      ,
        "advanced": "封闭图形上的植树（长方形/三角形周长）、两侧种树（×2）、多种间距求最小公倍数（重复点）、植树问题与等差数列的结合。"
      }
,
  {
        "id": "MATH-04-022",
    ...
    "solveSteps": [
            "第1步·交换律识别：看到25和4/125和8→交换到一起凑整。25×37×4→交换为25×4×37=100×37=3700。",
            "第2步·结合律运用：先算能凑整的。125×(8×73)→(125×8)×73=1000×73=73000。",
            "第3步·分配律正用：拆分计算。102×45=(100+2)×45=100×45+2×45=4500+90=4590。",
            "第4步·分配律逆用：提取公因数。36×47+36×53=36×(47+53)=36×100=3600。"
          ],
    "commonMistakes": [
      {"type": "分配律漏乘项", "description": "(a+b)×c 只乘 a 忘了 b，写成 a×c+b。例如：25×(4+6)错算成25×4+6=106。正解：25×4+25×6=100+150=250。", "fix": "口诀：括号外面那个数，要跟括号里面每个数都握一次手。"},
      {"type": "交换律用错位置", "description": "在乘加混合算式中直接交换，如 3+5×2 错写成 3+2×5。正解：交换律只能在纯加法或纯乘法中使用。", "fix": "先看运算符号是不是全部相同。有加有乘时，乘除优先，不能随意交换。"},
      {"type": "结合律的小括号乱加", "description": "在不该加括号的地方加括号改变运算顺序。如 100-45-55 写成 100-(45-55)=110。正解：连减时括号里要变号：100-(45+55)=0。", "fix": "加括号规则：括号前是减号，括号里符号全变。括号前是除号同理。"}
    ],
    "oneLineModel": "运算定律 = 算式的'变形金刚'——换位置（交换律）、换组合（结合律）、拆分重组（分配律），本质是让计算更简单。",
    "transfer": {
      "description": "整数运算定律→小数运算定律推广（四下）→分数运算定律推广（五下），定律不变、数域扩展；分配律的'拆数'思维直接衔接五年级因数分解和六年级提取公因数。",
      "relatedTopics": ["四年级小数运算定律推广", "五年级分数运算定律推广", "六年级提取公因数（分配律逆用）", "初中合并同类项与多项式乘法"]
    },
    "advanced": {
      "description": "分配律逆用（提取公因数）是初中因式分解的前身；交换律和结合律是群论（抽象代数）的基础公理。",
      "futureTopics": ["提取公因数（分配律逆用）", "平方差公式与完全平方公式", "因式分解（提公因式法）", "群论与代数结构入门"]
    },
    "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是忘了定律，而是看不出用哪个定律能简便。先试试：36×47+36×53→扫一眼有没有相同的数→36出现了两次→这是分配律逆用的信号！提取36→36×(47+53)=36×100。找\"相同因数\"是解题钥匙。",
              "interactionType": "dynamic-question"
            }
  }
,
  ...
  ,
      ...
      ,
        "oneLineModel": "英语=词汇+语法+技能(听说读写)。多听→会读，多说→会写，多练→会用。"
      ,
        "transfer": "4年级英语→5年级能力提升→初中英语综合→高中英语进阶。"
      ,
        "advanced": "英语学习策略（可理解输入假说）、语感的科学培养、二语习得关键期理论。"
      }
,
  {
    ...
    "solveSteps": [
            "第1步·忽略小数点按整数乘：3.25×1.2→325×12=3900。注意因数中小数位数：3.25有2位、1.2有1位，共3位。",
            "第2步·点小数点：从积的右边起数出3位→3.900=3.9。0.45×0.8=360→共3位小数→0.360=0.36。",
            "第3步·运算定律推广：小数也适用整数运算定律。0.25×3.6×4=0.25×4×3.6=1×3.6=3.6（交换律凑1）。",
            "第4步·求积的近似数：3.25×1.2=3.9（精确），3.14159×2.7≈8.48（保留两位小数）。估算验证：3×1=3与3.9同数量级→合理。"
          ],
    "commonMistakes": [
      {"type": "小数位数数错", "description": "忘了数某个因数的小数位，或把末尾的0也算作小数位。正解：因数末尾的0在点小数点前不能省略，点完后再化简。", "fix": "口诀：先乘后点，点完再简。两个因数小数位之和 = 积的小数位数。"},
      {"type": "小数点对齐当成加减法", "description": "把乘法的竖式写成小数点对齐（像加减法那样），导致数位混乱。正解：小数乘法竖式不按小数点对齐，而是末位对齐。", "fix": "乘法竖式永远末位对齐，不要看小数点。小数点最后才处理。"},
      {"type": "积的末尾0忘记化简或过早去掉", "description": "计算过程中过早划掉末尾0导致小数位数错误，或忘记化简最终结果。正解：先完整点好小数点，再划掉小数末尾无意义的0。", "fix": "两步顺序不可颠倒：①点小数点 ②化简（去末尾0）。"}
    ],
    "oneLineModel": "小数乘法的本质：当整数算 → 数小数位 → 点小数点。小数点位置由两个因数的小数位数之和决定。",
    "transfer": {
      "description": "整数乘法→小数乘法（四下/五上）→分数乘法（五下/六上），核心都是'因数×因数=积'，区别在于小数点位置和约分技巧；积的近似数衔接四年级四舍五入。",
      "relatedTopics": ["三年级整数乘法竖式", "四年级四舍五入求近似数", "五年级分数乘法", "六年级百分数乘法"]
    },
    "advanced": {
      "description": "小数乘法的'整数化'策略本质是单位换算思维（把元化成分）；小数乘法的运算定律推广是代数运算律普适性的体现。",
      "futureTopics": ["科学记数法与小数", "循环小数化分数", "比例中的小数运算", "物理中的有效数字与小数"]
    },
    "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会整数乘法，而是忘了数两个因数一共有几位小数。先试试：3.25×1.2，把3.25的小数点后数字（25）数一遍→2位，1.2的小数点后（2）数一遍→1位，总共3位。从3900右边起数3位点小数点→3.900→3.9。",
              "interactionType": "dynamic-question"
            }
  }
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会加减，而是异分母时直接加减了分子分母。先试试：1/2+1/3，把两个分数想象成不同大小的积木块——半块和三分之一块，它们不能直接拼。你得把它们切成相同大小的小块（通分：3/6和2/6），然后再拼起来=5/6。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·同分母直接相加减：分母不变，分子相加减。3/8+2/8=(3+2)/8=5/8。结果要约分：6/8=3/4。结果是假分数可化为带分数：9/8=1又1/8。",
            "第2步·异分母先通分：找分母的最小公倍数。1/3+2/5→公分母15→1/3=5/15，2/5=6/15→5/15+6/15=11/15。",
            "第3步·带分数加减：整数部分和分数部分分别相加减。2又1/3+1又1/2=2+1+(1/3+1/2)=3+(2/6+3/6)=3+5/6=3又5/6。",
            "第4步·混合运算按四则顺序：有括号先算括号，然后通分计算。验算：用小数近似值粗略检验——1/3≈0.33，2/5=0.4，和≈0.73，而11/15≈0.733，一致。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "异分母直接加分子分母",
                "description": "1/2+1/3=(1+1)/(2+3)=2/5（错误！）",
                "fix": "不同分母不能直接加！就好比2个苹果+3个橘子≠5个苹果橘子。必须先通分变相同单位。"
              },
              {
                "type": "带分数减法中分数部分不够减",
                "description": "3又1/4-2又3/4→1/4-3/4不够减，孩子直接写负数。",
                "fix": "从整数部分借1（即4/4）：3又1/4=2又5/4，然后2又5/4-2又3/4=2/4=1/2。"
              },
              {
                "type": "结果忘约分",
                "description": "2/3+1/3=3/3=1，孩子写成3/3不再简化。",
                "fix": "结果一定要约分到最简。3/3=1，6/8=3/4，养成最后一步检查是否能约分的习惯。"
              }
            ]
      ,
        "oneLineModel": "同分母加减：分母不变分子加减。异分母：先通分再加减。结果必须约分到最简。"
      ,
        "transfer": "分数加减法→五年级分数乘除法→六年级分数混合运算→六年级百分数运算→初中分式运算。"
      ,
        "advanced": "分数裂项（1/n-1/(n+1)=1/[n(n+1)]的应用）、等差数列求和用分数表达、连分数、真分数分解为单位分数。"
      }
,
  {
        "id": "CHI-05-006",
  ...
  ,
      ...
      ,
        "oneLineModel": "阅读理解=通读→定位→分析→作答。答案在文中，概括要精炼。"
      ,
        "transfer": "5年级阅读→6年级阅读深度提升→初中现代文/文言文阅读体系。"
      ,
        "advanced": "文本结构分析（总分/并列/递进）、修辞手法赏析、作者意图与读者反应的互动。"
      }
,
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是看不懂单词，而是想逐字逐句全部翻译成中文。先试试：不要翻译！用英文思维扫一遍→第一遍只看谁(Who)做了什么(What)，生词跳过。看完能用一句话说大意就算成功。第二遍再精读。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·Skim略读：快速扫一遍全文，不纠结生词。看标题/首段/尾段/每段首句→30秒内了解大意：Who?What?Where?When?",
            "第2步·Scan定位：看题目→圈出题目中的关键词(人名/地名/数字)→回到文中快速定位这些词→精读关键词所在的句子和前后各一句。",
            "第3步·推断生词：遇到不认识的词→看上下文推测。\"The boy was famished, so he ate three bowls of rice\"→famished≈very hungry（从结果反推原因）。",
            "第4步·检查答案：把答案代入原文→逻辑是否通顺→时态是否一致→拼写是否正确。特别是问答题，检查首字母大写和句号。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "遇到生词就停下来查字典",
                "fix": "一两个生词不影响理解大意。先猜再查，培养猜词能力比查字典更重要"
              },
              {
                "type": "用自己的知识回答而不是依据原文",
                "fix": "阅读理解=读懂作者的意图，不是表达你的观点。答案必须在原文中有依据"
              },
              {
                "type": "True/False题看漏NOT GIVEN",
                "fix": "True=原文确认，False=原文否定，NOT GIVEN=原文没提。没提到≠错误"
              }
            ]
      ,
        "oneLineModel": "英语阅读=Skim大意→Scan定位→Guess生词→Check答案。答案在文中，猜词靠上下文。"
      ,
        "transfer": "5年级阅读→6年级文章长度/难度提升→初中英语阅读理解→高中完形填空。"
      ,
        "advanced": "批判性阅读（区分事实与观点）、篇章结构分析（topic sentence→supporting details→conclusion）、略读与寻读的效率训练。"
      }
,
  {
        "id": "MATH-06-022",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会方程，而是假设法里\"每换1只差多少脚\"算错了。先试试：假设笼子里全是鸡→35×2=70脚。实际94脚→差了24脚。1只鸡换1只兔→脚数从2变4→多2脚。要补上这24脚→24÷2=12→需要换12只兔。鸡=35-12=23只。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·假设法（全是鸡）：鸡兔共35头94脚。假设全是鸡→35×2=70脚→比实际少94-70=24脚。1只鸡换1只兔多2脚→需换24÷2=12只→兔=12只，鸡=35-12=23只。",
            "第2步·方程法：设兔x只→鸡=35-x只→4x+2(35-x)=94→4x+70-2x=94→2x=24→x=12。验证：兔12只→48脚，鸡23只→46脚，共94✓。",
            "第3步·进阶变形：\"答对1题得5分，答错1题扣3分，20题得76分\"→设答对x题→5x-3(20-x)=76→5x-60+3x=76→8x=136→x=17题。注意扣分是减法！",
            "第4步·三种量鸡兔同笼：\"1元、5元、10元共20张共88元\"→设1元x张，5元y张，10元(20-x-y)张→x+5y+10(20-x-y)=88→化简求解。配合\"5元比1元多3张\"等额外条件。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "假设法比例算错",
                "description": "每换1只差2脚，总差24脚→24÷2=12→换12只。孩子可能24×2=48。",
                "fix": "每换1只的变化量=4-2=2脚（鸡变兔）或2-4=-2脚（兔变鸡）。总差额÷单位差额=要换的数量。"
              },
              {
                "type": "\"扣分\"题当\"得0分\"处理",
                "description": "\"答错扣3分\"→方程写成5×正确-0×错误=总分（错，应-3×错误）。",
                "fix": "扣分=减去分数。答错不但不给5分还要倒扣3分→损失=5+3=8分（相对于答对）。"
              },
              {
                "type": "三种量时方程约束不足",
                "description": "三种动物只给头数和脚数→2个方程3个未知数→有无穷多解。需要额外条件。",
                "fix": "三种量需要3个独立条件。检查题目是否有\"A是B的2倍\"之类额外条件，或隐含条件（如数量为整数）。"
              }
            ]
      ,
        "oneLineModel": "鸡兔同笼：假设法=假设全鸡→总差额÷单位差额=换的数量。方程法=设未知数列等式。扣分问题：答错=扣分而非不得分。"
      ,
        "transfer": "鸡兔同笼→六年级列方程解应用题→初中二元一次方程组→线性规划初步→博弈论中的混合策略。"
      ,
        "advanced": "鸡兔同笼的多种解法（抬脚法、列表法、面积法）、三种及以上变量的推广、\"百钱买百鸡\"不定方程。"
      }
,
  {
        "id": "ENG-04-009",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会乘，而是忘记先约分再乘。先试试：3/8×4/9，用红笔把3和9圈起来（可以约分），用蓝笔把4和8圈起来（也可以约分）。约完之后剩下的分子分母相乘就简单多了——1/2×1/3=1/6。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·分数乘整数：分子×整数，分母不变。3/4×5=(3×5)/4=15/4=3又3/4。可以先约分再乘：3/8×4=3/(8÷4)×(4÷4)=3/2×1=3/2。",
            "第2步·分数乘分数：分子×分子，分母×分母。2/3×3/5=(2×3)/(3×5)=6/15=2/5。交叉约分：2/3×3/5→3和3约掉→2/1×1/5=2/5。",
            "第3步·运算定律推广：乘法交换律/结合律/分配律对分数也适用。1/2×3/4×8=1/2×8×3/4=4×3/4=3（交换律凑整）。",
            "第4步·求一个数的几分之几：用乘法。求12的3/4→12×3/4=9。画图验证：把12个圆平均分4份，每份3个，取3份=9个。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "整数乘分数时忘加分母",
                "description": "3×2/5直接写6/5（正确），但孩子算成3×2=6漏分母→6。",
                "fix": "整数=整数/1。3=3/1→3/1×2/5=6/5。想象把3个完整的饼每份切成5分之2大小。"
              },
              {
                "type": "忘记约分",
                "description": "3/8×4/9=12/72就停了，应该继续约分=1/6。",
                "fix": "乘之前先交叉约分：3/8×4/9→3和9约=1和3→4和8约=1和2→1/2×1/3=1/6。"
              },
              {
                "type": "\"求一个数的几分之几\"和\"已知几分之几求原数\"混淆",
                "description": "求12的3/4用乘法(×3/4)，已知一个数3/4是12求原数用除法(÷3/4)。孩子常统一用乘法。",
                "fix": "\"求A的几分之几\"=A×分数；\"已知几分之几是A求原数\"=A÷分数。"
              }
            ]
      ,
        "oneLineModel": "分数乘法：分子×分子/分母×分母，乘前先约分。求一个数的几分之几用乘法。"
      ,
        "transfer": "分数乘法→五年级分数除法（除以一个分数=乘它的倒数）→六年级比和比例→初中分式乘法。"
      ,
        "advanced": "分数乘法的几何意义（面积模型：2/3×3/5=2/3的3/5）、单位分数连乘的规律、分数在音乐节奏中的乘法。"
      }
,
  {
        "id": "MATH-05-023",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是公式忘了，而是半径和直径的关系搞混了。先试试：在题目中圈出\"半径\"还是\"直径\"——如果是直径10cm，先画一条横线穿过圆心，标10cm，然后半条是5cm。算出r=5cm再代入公式C=2×3.14×5。",
              "interactionType": "dynamic-question"
            },
        "chip": {
              "script": "圆的所有公式都从πr²和2πr出发。周长÷π÷2=半径，半径×半径×π=面积。记住π=3.14就够了。",
  ...
  ,
        "solveSteps": [
            "第1步·认识圆的要素：圆心O决定位置，半径r决定大小。直径d=2r经过圆心。同圆中所有半径相等、所有直径相等。周长C=πd=2πr，面积S=πr²。",
            "第2步·算周长：已知半径r=5cm→C=2×3.14×5=31.4cm。已知直径d=10cm→C=3.14×10=31.4cm。半圆周长=C÷2+d=15.7+10=25.7cm（别忘加直径）。",
            "第3步·算面积：已知r=5cm→S=3.14×5²=3.14×25=78.5cm²。已知d=10cm→先求r=5cm→S=78.5cm²。环形面积=大圆面积-小圆面积=π(R²-r²)。",
            "第4步·扇形面积：圆心角n°的扇形面积=(n/360)×πr²。例如半径6cm圆心角60°→扇形面积=60/360×3.14×36=(1/6)×113.04=18.84cm²。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "圆周长公式用成面积公式",
                "description": "C=πr²（错误，这是面积）。正确：C=2πr。",
                "fix": "区分：周长=围一圈的长度（单位cm），面积=圆面的大小（单位cm²）。公式：C=2πr，S=πr²。"
              },
              {
                "type": "半圆周长忘加直径",
                "description": "半圆周长=πr+d，孩子只算πr=15.7忘加直径10→25.7。",
                "fix": "画图：半圆周长=半个圆弧+一条直径。绕半圆走一圈要经过弧+直径这两段。"
              },
              {
                "type": "面积单位写成cm",
                "description": "S=78.5cm²的结果写成78.5cm。",
                "fix": "面积单位一定带²。cm×cm=cm²，记住这一点。"
              }
            ]
      ,
        "oneLineModel": "圆心定位置、半径定大小。C=2πr=πd，S=πr²。半圆周长=πr+d，环形面积=π(R²-r²)。"
      ,
        "transfer": "圆→六年级扇形统计图（圆心角决定占比）→六年级圆柱与圆锥（圆柱体积=πr²h）→初中弧长与扇形面积公式。"
      ,
        "advanced": "圆周率π的历史（祖冲之）、圆中方与方中圆（内接/外切正方形与圆面积比）、圆幂定理、阿基米德割圆术。"
      }
,
  {
        "id": "ENG-05-014",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算百分数，而是\"赚了20%\"和\"打8折\"这两个20%和8折不是一回事。先试试：进价100元，赚20%→卖120元。打8折→是标价的80%。一个管赚多少，一个管打几折。分清\"利润率\"和\"折扣率\"。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解利润：利润=售价-成本，利润率=利润÷成本×100%。进价100元售价140元→利润=40元，利润率=40%。亏本=售价<成本→利润为负。",
            "第2步·打折促销：成本100元，期望利润率50%→定价=150元。打8折→售价=150×0.8=120元→利润=20元→实际利润率=20%。用一元一次方程：设成本x→x(1+50%)×0.8-x=所求。",
            "第3步·求成本：售价120元，赚了20%→成本=120÷(1+20%)=100元。售价120元，亏了20%→成本=120÷(1-20%)=150元。注意：赚20%÷1.2，亏20%÷0.8。",
            "第4步·混合利润：A商品成本100利润率30%，B商品成本200利润率20%→总利润=100×30%+200×20%=30+40=70元→总利润率=70÷300≈23.3%。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "利润率和折扣混淆",
                "description": "\"利润率50%\"→定价=成本×1.5。\"打5折\"→售价=定价×0.5。两者本质不同。",
                "fix": "利润率=(售价-成本)÷成本；折扣=售价÷标价。利润率看赚多少，折扣看打几折。"
              },
              {
                "type": "赚20%和亏20%成本不同",
                "description": "售价都是120元→赚20%→成本100，亏20%→成本150。",
                "fix": "赚了20%=成本×(1+20%)=售价；亏了20%=成本×(1-20%)=售价。用除法求成本。"
              },
              {
                "type": "总利润率取平均",
                "description": "利润率30%和20%的两种商品→总利润率=25%（错误，除非成本相同）。",
                "fix": "加权平均：总利润÷总成本。不是利润率直接平均。"
              }
            ]
      ,
        "oneLineModel": "利润=售价-成本，利润率=利润÷成本×100%。定价=成本×(1+利润率)，售价=定价×折扣。"
      ,
        "transfer": "利润问题→六年级百分数应用→六年级比例→初中一次函数（利润=单价×数量-成本→线性关系）→高中导数求最大利润。"
      ,
        "advanced": "盈亏平衡点（保本销量）、边际利润、分段定价（量大从优）、进销存数学模型。"
      }
,
  {
        "id": "CHI-04-006",
  ...
  ,
      ...
      ,
        "oneLineModel": "阅读理解=通读→定位→分析→作答。答案在文中，概括要精炼。"
      ,
        "transfer": "4年级阅读→5年级阅读深度提升→初中现代文/文言文阅读体系。"
      ,
        "advanced": "文本结构分析（总分/并列/递进）、修辞手法赏析、作者意图与读者反应的互动。"
      }
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不理解分数线，而是约分和通分这两个操作搞混了。先试试：把\"约分\"想象成\"化简\"——让分数变得更简单（分子分母同时变小）；把\"通分\"想象成\"统一口径\"——让两个分数有相同的分母才能比较或相加减。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解分数意义：把单位\"1\"平均分成若干份，表示其中一份或几份的数。例如3/4=把1个蛋糕平均分4份取3份；也可以表示3÷4=0.75。",
            "第2步·区分真分数假分数：真分数=分子<分母→值<1（如3/4）；假分数=分子≥分母→值≥1（如7/4=1又3/4）。带分数=整数+真分数（如1¾）。",
            "第3步·约分（化最简分数）：分子分母同时除以它们的最大公因数。18/24→分子分母÷6→3/4。验证：3/4不能再约分（3和4互质）。",
            "第4步·通分（统一分母）：找分母的最小公倍数作为公分母。1/3和2/5→公分母15→1/3=5/15，2/5=6/15→可比较大小（5/15<6/15）。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "认为分母大的分数就大",
                "description": "1/3和1/4比大小，认为1/4>1/3因为4>3。",
                "fix": "分子相同时，分母越大分数越小（分得份数越多每份越小）。1/3≈0.33，1/4=0.25，确实1/3更大。"
              },
              {
                "type": "约分不彻底",
                "description": "18/24约成9/12就停了，其实还可以再约成3/4。",
                "fix": "算出分子和分母的最大公因数，一次性除以它。18和24的最大公因数是6→18÷6=3,24÷6=4→3/4。"
              },
              {
                "type": "假分数化带分数算错整数部分",
                "description": "7/4→7÷4=1余3→1又3/4，孩子写成7/4=3又1/4(余数和商搞反)。",
                "fix": "分子÷分母=整数部分……余数。余数做新分子，分母不变。7÷4=1……3→1又3/4。"
              }
            ]
      ,
        "oneLineModel": "分数=分子÷分母。真分数<1，假分数≥1。约分=分子分母÷最大公因数，通分=找分母最小公倍数统一分母。"
      ,
        "transfer": "分数意义→五年级分数加减法（同分母直接加减，异分母先通分）→五年级分数乘除法→六年级比和比例→初中分式运算。"
      ,
        "advanced": "埃及分数（分子为1的单位分数拆分）、连分数与黄金分割、分数在音乐音程中的应用（八度=2:1）、无穷级数中的分数。"
      }
,
  {
        "id": "MATH-06-004",
    ...
    "solveSteps": [
            "第1步·理解折扣：几折=百分之几十。8折=80%，八五折=85%。现价=原价×折扣。例如原价200元打8折→200×80%=200×0.8=160元。",
            "第2步·算税率：应纳税额=应纳税所得额×税率。月工资6000元，超过5000元的部分1000元×3%=30元。营业额×营业税税率=营业税额。",
            "第3步·算利息：利息=本金×利率×时间。存10000元定期1年年利率2%→10000×2%×1=200元。税后利息=利息×(1-利息税率)。",
            "第4步·成数：一成=10%。粮食产量比去年增产二成→今年=去年×(1+20%)。去年1000kg→今年=1000×1.2=1200kg。"
          ],
    "commonMistakes": [
      {"type": "忘记约分", "description": "算出结果后不化简，如 2/3×3/4=6/12 不约分成 1/2。正解：乘完后必须约分到最简分数，或者先约后乘。", "fix": "最佳策略：先约后乘。把两个分数的分子分母交叉约分，能大大减少计算量。"},
      {"type": "带分数直接乘", "description": "带分数1½×2/3写成 1×2 / 2×3 = 2/6。正解：带分数必须先化成假分数：1½=3/2。", "fix": "规则：分数乘法中，带分数不得直接参与计算，一律先化假分数。"},
      {"type": "整数乘分数时分母遗忘", "description": "3 × 2/5 写成 6/5 是对的，但有人误写成 3/2×5=3/10。正解：整数可以看作分母为1的分数：3=3/1。", "fix": "整数×分数：整数只乘分子，分母不变。3 × 2/5 = (3×2)/5 = 6/5。"}
    ],
    "oneLineModel": "分数乘法 = 分子乘分子 / 分母乘分母，核心是先约后乘——约分越早，计算越少。",
    "transfer": {
      "description": "整数乘法→小数乘法→分数乘法，乘法法则从具体到抽象逐级升级；分数乘法是六年级分数除法（除以一个数=乘它的倒数）和百分数计算的基础。",
      "relatedTopics": ["六年级分数除法（倒数概念）", "六年级百分数与分数互化", "六年级比与比例中的分数运算", "初中分式乘法"]
    },
    "advanced": {
      "description": "分数乘法的'先约后乘'策略体现了数学中'先简化再计算'的高阶思维；分子分母独立运算的结构为初中分式运算奠定基础。",
      "futureTopics": ["分数裂项（1/n(n+1) = 1/n - 1/(n+1)）", "繁分数化简", "分式方程中的乘法", "概率中的分数乘法（独立事件）"]
    },
    "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会百分数，而是把\"折\"和\"%\"搞混了。先试试：8折=80%=0.8。原价200元打8折→200×0.8=160元。记住口诀：\"折\"变\"十\"，八折就是80%。",
              "interactionType": "dynamic-question"
            }
  }
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算百分数，而是折上折时把折扣率直接相加了。先试试：一件500元的商品先打8折（×0.8），再打9折（×0.9）。500×0.8×0.9=500×0.72=360元。8折+9折≠17折，是72折。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·多步折扣计算：原价500元，先打8折再打9折≠500×0.8×0.9=360元。注意\"满300减50\"等叠加规则：满减后再打折还是打折后满减？读题确认顺序。",
            "第2步·分段税率：工资8000元→5000元免税→3000元×3%=90元。若超过8000元（如12000元）→5000免+3000×3%+4000×10%=90+400=490元。",
            "第3步·连续利息（单利）：本金10000元，年利率3%，存3年→利息=10000×3%×3=900元。若取出后再存→第二年本金=10900→利息=10900×3%=327→总利息=300+327=627元（仅当取出重存时）。",
            "第4步·综合应用：买一件原价800元的商品，双11打7折，再使用满500减50券→800×0.7=560，560-50=510元。相当于原价的510/800=63.75%→约6.4折。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "折上折时直接加折扣",
                "description": "先8折再9.5折→8+9.5=17.5折（错误）。正确：0.8×0.95=0.76=7.6折。",
                "fix": "折上折=折扣率相乘。8折×9.5折=0.8×0.95=0.76=七六折。"
              },
              {
                "type": "分段税率漏算某段的超额",
                "description": "月薪12000→直接×10%=1200（错误，应为分段计）。",
                "fix": "画数轴分段标注：0-5000免税，5000-8000按3%，8000-12000按10%→分段计算后求和。"
              },
              {
                "type": "存期换算错误",
                "description": "年利率2.5%，存6个月→6个月=0.5年→利息=本金×2.5%×0.5。",
                "fix": "利率和存期单位要匹配。年利率配年，月利率配月。6个月=0.5年。"
              }
            ]
      ,
        "oneLineModel": "百分数应用：折扣=×折扣率，折上折=折扣率连乘。分段税率=按收入区间分段×税率再求和。利息=本金×利率×时间。"
      ,
        "transfer": "百分数(二)→六年级比例（折扣可看作前项÷后项）→初中函数（税率函数是分段函数）→高中数列（复利模型）。"
      ,
        "advanced": "复利终值公式（A=P(1+r)ⁿ）、分期付款的等额本息计算、税收筹划的数学原理、机会成本与沉没成本。"
      }
,
  {
        "id": "CHI-06-005",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是完全不会，而是不知道题目到底在问什么。先试试：把题目读三遍，第一遍正常读，第二遍圈关键词，第三遍用自己的话说一遍\"题目要我做什么\"。很多时候，答不出来是因为没读懂题意。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·审题定位：圈出题目中的关键词，明确这道题在考什么（字词/阅读/写作/口语交际）。",
            "第2步·回顾相关知识：在脑中回想老师讲过的相关知识点。如果是阅读题→回想\"联系上下文\"的方法；如果是字词题→回想偏旁部首规律。",
            "第3步·运用方法答题：用学过的方法一步步解答。不确定时先在草稿纸上试写，再誊写到答题区。",
            "第4步·检查：默读一遍答案→检查有无错别字→检查是否答非所问→补充遗漏要点。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "审题不清答非所问",
                "fix": "用笔画出题目中的\"不/没有/除了\"等限定词，明确答题方向"
              },
              {
                "type": "答题不完整",
                "fix": "\"为什么\"类题目必须写原因和结果两部分。只用关键词作答不得分"
              },
              {
                "type": "书写潦草扣卷面分",
                "fix": "字迹工整、大小一致、不涂改。平时练字十分钟，考试不吃亏"
              }
            ]
      ,
        "oneLineModel": "语文=字词基础+阅读理解+写作表达。读得多+写得多+想得多=语感形成。"
      ,
        "transfer": "6年级语文→7年级能力提升→初中语文综合素养。"
      ,
        "advanced": "群文阅读策略、批判性思维培养、语文核心素养四维（语言/思维/审美/文化）。"
      }
,
  {
        "id": "ENG-06-015",
...
,
  ...
  ,
      ...
      ,
        "oneLineModel": "语文=字词基础+阅读理解+写作表达。读得多+写得多+想得多=语感形成。"
      ,
        "transfer": "4年级语文→5年级能力提升→初中语文综合素养。"
      ,
        "advanced": "群文阅读策略、批判性思维培养、语文核心素养四维（语言/思维/审美/文化）。"
      }
,
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不理解因数是什么，而是找因数时总是漏掉几个。先试试：找18的所有因数，从1开始成对找——1×18，2×9，3×6。接下来4?不行，5?不行，6已经出现了——停！所以18的因数={1,2,3,6,9,18}，一共6个。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解因数和倍数：如果A÷B=整数（无余数），则B是A的因数，A是B的倍数。例如12÷3=4→3是12的因数，12是3的倍数。因数≤原数，倍数≥原数。",
            "第2步·找全因数：成对找——1×12、2×6、3×4→12的因数={1,2,3,4,6,12}。一个数的最大因数是它本身，最小因数是1。",
            "第3步·用倍数特征筛选：2的倍数→个位0/2/4/6/8；5的倍数→个位0/5；3的倍数→各位数字之和是3的倍数。例如234→2+3+4=9是3的倍数→234是3的倍数。",
            "第4步·判断质数合数：质数=只有1和本身两个因数（2,3,5,7,11,13…）；合数=有3个及以上因数；1既不是质数也不是合数。100以内质数共25个，可背口诀判断。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "漏掉1和本身",
                "description": "找12的因数漏了1和12。",
                "fix": "成对找因数：先写1×12，然后问2×?=12，3×?=12…直到两个因数相遇。这样不会漏。"
              },
              {
                "type": "3的倍数特征用错",
                "description": "判断234是否为3的倍数→2+3+4=9→9是3的倍数→234是3的倍数。孩子可能只加前两位或只看个位。",
                "fix": "必须把所有数位上的数字加在一起，和是3的倍数才行。234=200+30+4，拆开后每部分都是3的倍数。"
              },
              {
                "type": "1是质数的误解",
                "description": "认为1也是质数。1只有1个因数（自己），不符合\"恰好2个因数\"的定义。",
                "fix": "质数=恰好有2个不同因数（1和自己）。1只有一个因数→不是质数。2是最小的质数。"
              }
            ]
      ,
        "oneLineModel": "因数成对找，倍数无限多。2的倍数看个位偶，5的倍数个位0/5，3的倍数各位和。质数=恰好2个因数，合数=≥3个因数，1不是质也不是合。"
      ,
        "transfer": "因数和倍数→五年级最大公因数和最小公倍数→五年级分数约分（除以公因数）和通分（乘以最小公倍数）→六年级分数运算→初中整数性质。"
      ,
        "advanced": "质数筛法（埃拉托色尼筛）、费马小定理、完全数与梅森素数、哥德巴赫猜想、RSA加密中的大质数分解。"
      }
,
  {
        "id": "CHI-05-008",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算百分数，而是百分数、分数、小数三种形式之间的转换不熟练。先试试：把25%分别写成分数（1/4）和小数（0.25），然后试试这三个\"面孔\"在题目中互换——同一道题，用哪种形式算最快？",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解百分数：百分数表示一个数是另一个数的百分之几，不写单位。45%=45/100=0.45。\"出勤率98%\"→出勤人数÷总人数×100%=98%。",
            "第2步·百分数化小数：去掉%→小数点左移2位。45%=0.45，3.5%=0.035，120%=1.2。小数化百分数：小数点右移2位→加%。0.35=35%，1.2=120%。",
            "第3步·百分数化分数：%改写为/100再约分。45%=45/100=9/20。12.5%=12.5/100=125/1000=1/8。分数化百分数：先化小数再×100%。",
            "第4步·常见百分数分数互化速记：25%=1/4，50%=1/2，75%=3/4，20%=1/5，12.5%=1/8，33.3%≈1/3。用这些已知值快速估算：一件60元的商品打75折→60×0.75=60×3/4=45元。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "百分数化小数方向反",
                "description": "45%→4.5（左移了2位但去掉%后没理解）。正确：45%=0.45。",
                "fix": "去掉%=÷100=小数点左移两位。加%=×100=小数点右移两位。"
              },
              {
                "type": "大于100%的百分数不理解",
                "description": "认为120%不可能存在（一个数不能是另一个数的120%）。",
                "fix": "百分数可以>100%，表示超过整体。120%=1.2倍。今年产量是去年的120%=增长了20%。"
              },
              {
                "type": "百分数和分数乘除混淆",
                "description": "\"一个数的25%是20\"→20×25%=5（错误）。正确：20÷25%=20÷0.25=80。",
                "fix": "25%=1/4→\"一个数的1/4是20\"→20÷(1/4)=80。"
              }
            ]
      ,
        "oneLineModel": "百分数=分母为100的分数。化小数去%左移2位，化分数写/100再约分。25%=1/4，50%=1/2，75%=3/4。"
      ,
        "transfer": "百分数(一)→六年级百分数(二)（折扣/成数/税率/利率）→六年级扇形统计图→初中统计与概率。"
      ,
        "advanced": "百分比的变化率（增长了百分之几 vs 增长到百分之几）、复合百分比（连续两年各降10%≠降20%）、百分等级。"
      }
,
  {
        "id": "CHI-06-004",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是背不下来，而是没理解意思就硬背。先试试：把这首诗画成一幅画——每句诗对应画面上的一处。画完这幅画，诗也就记住了，而且是理解着记住的。",
              "interactionType": "dynamic-question"
            },
        "chip": {
              "script": "古诗学习三件套：先读准字音，再解关键字词，最后翻译整句。默写之前先理解意思，死记硬背改不了错别字！",
  ...
  ,
        "solveSteps": [
            "第1步·解诗题：题目告诉了什么？\"望庐山瀑布\"→望=远看，庐山=地点，瀑布=描写对象。",
            "第2步·逐句翻译+想象画面：\"飞流直下三千尺\"→瀑布从高处飞泻而下，像三千尺那么长→画面：白色水帘从天而降，气势磅礴。",
            "第3步·抓诗眼品情感：找出最能表达情感的字。\"疑是银河落九天\"→\"疑\"=好像→诗人把瀑布比作银河→表达惊叹和赞美之情。",
            "第4步·背诵+默写：理解意思后朗读3遍→遮住原文尝试背诵→默写→对照检查错字→重点记忆易错字（\"疑\"不要写成\"凝\"）。"
          ]
      ,
        "commonMistakes": [
              "[{'type': '死记硬背不理解意思', 'fix': '先理解每句的意思，在脑中想象画面。能画出来的诗才真正记住了'}, {'type': '默写时写同音错别字', 'fix': '\"床前明月光\"不是\"窗前明月光\"。理解词语后再默写：床=井栏，不是床铺'}, {'type': '赏析题答不具体', 'fix': '用\"这句诗用了XX手法，写出了XX的画面，表达了XX的情感\"的模板'}]"
            ]
      ,
        "oneLineModel": "学古诗=解诗题→明诗意→想画面→悟诗情→背默写。诗中有画，画中有情。"
      ,
        "transfer": "6年级古诗→7年级诗词量增加/难度提升→初中文言文体系。"
      ,
        "advanced": "格律诗平仄入门、意象系统（月/柳/雁的象征意义）、诗人和时代背景。"
      }
,
  {
        "id": "CHI-06-014",
...
,
  ...
  ,
      ...
      ,
        "oneLineModel": "英语阅读=Skim大意→Scan定位→Guess生词→Check答案。答案在文中，猜词靠上下文。"
      ,
        "transfer": "4年级阅读→5年级文章长度/难度提升→初中英语阅读理解→高中完形填空。"
      ,
        "advanced": "批判性阅读（区分事实与观点）、篇章结构分析（topic sentence→supporting details→conclusion）、略读与寻读的效率训练。"
      }
,
  ...
  ,
      ...
      ,
        "oneLineModel": "语文=字词基础+阅读理解+写作表达。读得多+写得多+想得多=语感形成。"
      ,
        "transfer": "5年级语文→6年级能力提升→初中语文综合素养。"
      ,
        "advanced": "群文阅读策略、批判性思维培养、语文核心素养四维（语言/思维/审美/文化）。"
      }
,
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是记忆力不好，而是用\"背电话号码\"的方式在背单词——a-p-p-l-e苹果，a-p-p-l-e苹果。先试试：把单词读出来，按发音分段：a-pple。大脑对声音的记忆远比字母顺序深刻。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·音标记单词：根据发音拆音节。interesting→in-ter-es-ting。会读就会拼，发音和拼写是对应的。",
            "第2步·词根词缀法：un+happy=unhappy(不快乐)，teach+er=teacher(老师)。前缀改词义，后缀改词性。",
            "第3步·造句记忆：每个新词造2个英文句子→一句话用I/We作主语，一句话用He/She作主语。在语境中记忆比孤立背诵有效10倍。",
            "第4步·联想归类：同类词放一起记。水果类→apple/banana/orange/grape；动作类→run/jump/swim/fly。大脑容易记住有联系的东西。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "只会拼不会用",
                "fix": "记住单词必须能造句。只会拼不会用的单词是\"死单词\""
              },
              {
                "type": "中文式直译",
                "fix": "\"看书\"不是see a book而是read a book。搭配(collocation)比单词本身更重要"
              },
              {
                "type": "同音/形近词混淆",
                "fix": "their/there/they're→their=他们的，there=那里，they're=they are。分开记语境"
              }
            ]
      ,
        "oneLineModel": "记单词=音(发音拼写对应)+形(词根词缀)+义(语境造句)+类(联想归类)。会用>会拼。"
      ,
        "transfer": "6年级词汇→7年级词汇量扩充→初中1600词→高中3500词。"
      ,
        "advanced": "词源学（etymology）入门、英语词汇的拉丁/希腊语根源、学术词汇和日常词汇的语域差异。"
      }
,
  {
        "id": "ENG-04-010",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算比，而是化简比和求比值这两个操作搞混了。先试试：20:15，化简比=4:3（答案里还有冒号），求比值=20÷15=4/3（答案是一个数）。记住：化简比的答案里必须有冒号。",
              "interactionType": "dynamic-question"
            },
        "chip": {
              "script": "比是小学数学的核心考点。掌握方法，举一反三，所有变式题都不怕！",
  ...
  ,
        "solveSteps": [
            "第1步·理解比：比表示两个量的倍数关系。A:B=A÷B=比值。例如男生20人女生15人→20:15=4:3（化简），比值=4/3。比和除法、分数本质相同。",
            "第2步·化简比：比的前项和后项同时除以最大公因数。36:48→÷12→3:4。含小数的比先化为整数比：0.6:0.8=6:8=3:4。含分数的比先通分：1/2:1/3=3/6:2/6=3:2。",
            "第3步·按比例分配：已知总量和比，先求总份数→每份量→各部分量。120元按3:1分→总份数3+1=4→每份120÷4=30→3份=90元，1份=30元。",
            "第4步·比的应用题：抓住\"不变量\"。盐水1:4→盐10g水40g→水不变加盐变2:5→设加盐x→(10+x):40=2:5→5(10+x)=80→50+5x=80→x=6g。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "化简比和求比值混淆",
                "description": "20:15化简=4:3（仍用:表示），比值=4/3（一个数）。孩子把化简比写成4/3。",
                "fix": "化简比的结果还是比（用:连接），比值是一个数（分数/小数）。"
              },
              {
                "type": "不同单位直接比",
                "description": "2m:50cm直接写2:50（错误）。先统一单位：2m=200cm→200:50=4:1。",
                "fix": "比的前后项必须是相同单位。不同单位先化成相同单位再比。"
              },
              {
                "type": "按比例分配时总份数算错",
                "description": "按2:3:5分配→总份数2+3+5=10。孩子算成2×3×5=30。",
                "fix": "总份数=比的各项相加（不是相乘）。因为总量被分成了2+3+5=10份。"
              }
            ]
      ,
        "oneLineModel": "比=两个量的倍数关系。化简比=前后项÷最大公因数，比值=前项÷后项。按比例分配：总量÷总份数×各项份数。"
      ,
        "transfer": "比→六年级比例（正反比例判断需要比的概念）→六年级百分数→初中相似三角形（边长比=相似比）。"
      ,
        "advanced": "连比（a:b:c）、反比（b:a）、复比（(a:b)×(c:d)）、黄金比例(1:1.618)及其在艺术和建筑中的应用。"
      }
,
  {
        "id": "CHI-05-005",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是知识点不懂，而是复习没有章法——东看一下西看一下。先试试：拿出一张白纸，默写三大板块的知识点（不许看书）。写不出来的就是你的薄弱点→重点突破这些。复习=先找到\"不知道\"的地方，再把它变成\"知道\"。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·系统梳理：三大板块——1)大数读写+四则运算+运算定律+小数；2)角+三角形+图形的运动；3)条形统计图。",
            "第2步·重难点突破：大数0的读写→分级解决；分配律逆向→找公因数；三角形内角和→180°铁律；角的度量→内外圈一致。",
            "第3步·应用题策略：逐句翻译→圈关键词→画图辅助→列式计算→答案检验。行程问题画线段图，倍数关系画线段图。",
            "第4步·查漏补缺：做一张综合诊断卷→错题分类（概念不清/计算粗心/审题错误/方法不当）→针对性补练。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "考前突击不系统",
                "fix": "按知识导图逐一过关，每个知识点做3道典型题检验"
              },
              {
                "type": "应用题见数就乘除",
                "fix": "先判断数量关系（和/差/倍/比例）再选运算。看\"一共\"→加，\"相差\"→减，\"几倍\"→乘除"
              },
              {
                "type": "考试时间分配不合理",
                "fix": "选择填空15分钟→计算20分钟→应用题25分钟→检查10分钟"
              }
            ]
      ,
        "oneLineModel": "四年级数学=数(大数+运算律+小数)+形(角+三角形+对称平移)+统(条形图)。核心能力=运算+空间想象+数据阅读。"
      ,
        "transfer": "四年级→五年级(小数乘除法+多边形面积+分数+折线图)→六年级(圆+圆柱圆锥+扇形图)。"
      ,
        "advanced": "小升初衔接要点（分数运算/方程入门/比和比例提前感知）、四年级奥数精选（鸡兔同笼/和差倍/速算巧算）。"
      }
,
  {
        "id": "CHI-05-003",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是记不住这个字，而是和另一个长得很像的字搞混了。先试试：把这两个\"双胞胎\"字并排写下来→找不同之处→编一个口诀记住区别。\"己\"出头一点变\"已\"，\"巳\"全封口。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·拆字记形：把生字拆成偏旁+部件。\"潮\"=氵(水旁)+朝(声旁)→与水有关读cháo。",
            "第2步·组词扩词：用生字组3个词→每个词造1个句子。\"潮\"→潮水/潮汐/潮流→\"钱塘江的潮水非常壮观\"。",
            "第3步·辨析近义词：找近义词并区分用法。\"安静\"vs\"宁静\"→安静强调没有声音，宁静强调内心平和。各造一个句子。",
            "第4步·听写自测：遮住生字看拼音写汉字→对照检查→错字重写3遍→分析错因（多笔少画/偏旁错误/同音混淆）。"
          ]
      ,
        "commonMistakes": [
              "[{'type': '同音字混淆', 'fix': '\"在\"和\"再\"→\"在\"表位置/时间，\"再\"表重复。分别组词造句区分'}, {'type': '形近字写错', 'fix': '\"己/已/巳\"→口诀：己开已半巳全封。把形近字放一起对比记忆'}, {'type': '多音字读错', 'fix': '\"长\"cháng(长短)/zhǎng(长大)。根据词语判断读音，多读多练'}]"
            ]
      ,
        "oneLineModel": "字词学习=形(偏旁拆字)+音(多音字辨析)+义(组词造句)+写(听写自测)。"
      ,
        "transfer": "5年级字词→6年级词汇量扩展→初中文言文实词虚词积累。"
      ,
        "advanced": "汉字六书（象形/指事/会意/形声/转注/假借）、偏旁部首的文化内涵、形声字的声旁规律。"
      }
,
  {
        "id": "MATH-06-009",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是单个知识点不会，而是多个知识点交织在一起时不知道从哪里开始。先试试：把题目读三遍，每遍圈出一个不同的知识点（第一遍圈\"数\"，第二遍圈\"形\"，第三遍圈\"统计\"），然后逐一解决。",
              "interactionType": "dynamic-question"
            },
        "chip": {
              "script": "百分数就是分母为100的分数。折扣=现价÷原价，税率=税额÷收入，利率=利息÷本金。三个公式，一通百通。",
  ...
  ,
        "solveSteps": [
            "第1步·数与代数回顾：四则运算→小数分数百分数互化→方程→比和比例。核心：运算顺序和运算定律是所有计算的基础。",
            "第2步·图形与几何梳理：平面图形面积公式串联（长方形→平行四边形→三角形→梯形→圆），立体图形体积=底面积×高。图形的运动：平移+旋转+轴对称。",
            "第3步·统计与概率整理：条形图（比大小）→折线图（看趋势）→扇形图（看占比）。平均数=总量÷份数，可能性=有利÷总数。",
            "第4步·综合应用练习：一道题可能结合多个知识点。例：一个圆柱形水桶，底面半径10cm高30cm，装80%的水→涉及圆面积+圆柱体积+百分数→S=π×100×30=9420cm³×80%=7536cm³。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "知识点孤立记忆无法综合运用",
                "description": "一道题涉及分数+比例+几何，孩子只用了其中一个方法。",
                "fix": "做题前先圈出所有涉及的知识点，逐一标注，确保每个点都用到。"
              },
              {
                "type": "面积体积公式记串",
                "description": "把圆锥体积1/3πr²h算成πr²h（忘×1/3）。",
                "fix": "制作公式卡片：正面写图形名，反面写公式。每天随机抽3张自测。"
              },
              {
                "type": "单位不统一就代入公式",
                "description": "半径10cm高3dm→V=π×100×3=300π（错误，高应该是30cm）。",
                "fix": "先统一所有单位再计算。在题目旁边标注单位换算：3dm=30cm。"
              }
            ]
      ,
        "oneLineModel": "总复习=知识网络化：数与代数(计算+方程+比例)、图形与几何(面积+体积+运动)、统计与概率(图表+平均数+可能性)。"
      ,
        "transfer": "小学总复习→小升初衔接→初中数与代数/几何/统计三线并举的体系。"
      ,
        "advanced": "数学思想方法总结（数形结合、转化、模型、类比）、各知识点的交叉应用、小升初真题中的综合题。"
      }
,
  {
        "id": "MATH-06-016",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是某个知识点完全不会，而是多个知识点堆在一起时不知道该先处理哪个。先试试：拿到一道综合题，用三色笔——红色圈\"数\"相关（分数/百分数），蓝色圈\"形\"相关（圆/柱/锥），绿色圈\"统计\"相关。每圈一种就解决一种，逐个击破。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·知识点自查：列三列清单——数与代数（分数、百分数、比和比例、方程）、图形与几何（圆、圆柱圆锥、位置方向）、统计与概率（统计图选择、可能性）。标记薄弱点。",
            "第2步·典型题过关：每个知识点做3道典型题。分数运算→1/2+1/3÷(2/3-1/6)=1/2+1/3÷(1/2)=1/2+2/3=7/6。圆面积→r=5→S=78.5cm²。比例→3:x=5:15→x=9。",
            "第3步·综合题训练：跨知识点综合。\"一个圆柱形粮囤底面周长12.56m高3m，装了75%的粮食→每立方米粮食重0.7吨\"→先r=C÷2π=2m→V=π×4×3=37.68m³→装粮37.68×75%=28.26m³→重量=28.26×0.7=19.782吨。",
            "第4步·错题复盘：整理错题本，每道错题标注错因（计算粗心/公式记错/审题不清/方法不会），针对错因专项训练。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "混淆各知识点公式",
                "description": "圆周长C=πr²（把面积公式当周长用）。",
                "fix": "做公式对照表贴在墙上：C=2πr/πd，S=πr²，V柱=πr²h，V锥=1/3πr²h。每天早读看一遍。"
              },
              {
                "type": "综合题跳步漏知识点",
                "description": "圆柱装粮问题忘记乘75%（装粮率），只算了满仓体积。",
                "fix": "审题时用不同颜色的笔标注不同知识点：周长→蓝，体积→红，百分数→绿。确保每种颜色的信息都用到了。"
              },
              {
                "type": "总复习抓不住重点",
                "description": "平均用力复习所有内容，结果是薄弱点没补上。",
                "fix": "先做一套综合卷，找出错题对应的知识点，重点复习这些。80%的时间花在20%的薄弱点上。"
              }
            ]
      ,
        "oneLineModel": "小学数学体系=数与代数(计算+方程+比例)+图形与几何(平面+立体+运动)+统计与概率(图表+平均数+可能性)。"
      ,
        "transfer": "小学总复习→初中数学（三大模块深化为代数、几何、统计概率三线）→高中数学。"
      ,
        "advanced": "数学思想方法（分类讨论、转化与化归、数形结合、模型思想、方程思想）的综合运用、小升初压轴题突破。"
      }
,
  {
        "id": "MATH-06-011",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会找规律，而是没有把数和形结合起来看。先试试：把题目的数据列成表格——第1个图对应数字几？第2个对应几？…然后在旁边画一个简单的草图，看看\"每次增加的部分\"在图上对应什么。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·用图形表示数：1+3+5+7+9=？用小正方形拼成大正方形：1²=1个，1+3=2²=4个，1+3+5=3²=9个→规律：连续奇数和=n²。所以1+3+5+7+9=5²=25。",
            "第2步·用数表示图形：正方形点的总数=每边点数²。正三角形点数=1+2+3+…+n=n(n+1)/2。图中有多少个小正方形？数最外层边长×边长。",
            "第3步·找规律三步法：①列表格列出序号和对应值→②看相邻差是否等差/等比→③写出通项公式。例如：第1个图4根火柴，第2个7根，第3个10根→差恒为3→通项=3n+1。",
            "第4步·验证猜想：用n=4代入通项=3×4+1=13，实际画第4个图验证确实是13根。再用n=5→3×5+1=16对照验证。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "规律只看前两项就下结论",
                "description": "数列2,4,8…→猜测是2n（错误，8对应n=3→2×3=6≠8）。实际是2ⁿ。",
                "fix": "至少验证前4项。用第4项代入你的通项公式，如果不一致就重新找规律。"
              },
              {
                "type": "图形规律只看到表面没深入",
                "description": "看到火柴棒问题只数火柴，没发现每次增加的是同样的量（等差）。",
                "fix": "列表格：序号n|火柴数→第1行和第2行的差就是每次增加的量。"
              },
              {
                "type": "数形分离",
                "description": "用代数方法找规律时忘了画图，用几何方法时忘了写公式。",
                "fix": "任何时候都\"左手画图右手列式\"：左边画图形变化，右边列对应算式。"
              }
            ]
      ,
        "oneLineModel": "数形结合=用图形直观展示数的规律，用算式精确描述图形特征。连续奇数和=n²，三角形数=n(n+1)/2。"
      ,
        "transfer": "数与形→六年级找规律→初中数列（等差数列/等比数列通项公式）→初中函数图像的数形结合→高中解析几何。"
      ,
        "advanced": "正方形数(1,4,9,16…)、三角形数(1,3,6,10…)、五边形数、斐波那契数列的图形解释、杨辉三角与(a+b)ⁿ的关系。"
      }
,
  {
        "id": "MATH-04-023",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算，而是文字题翻译成算式时括号放错了位置。先试试：\"25加上15的和，除以8\"→\"和\"意味着25+15是一个整体→用括号包起来→(25+15)÷8。\"和\"\"差\"\"积\"\"商\"就是括号的信号。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·文字转算式：\"25加上15的和除以8乘3\"→(25+15)÷8×3。\"加上...的和\"→先加，用括号括起来。",
            "第2步·从最内层括号算起：(25+15)÷8×3=40÷8×3。小括号→中括号→大括号逐层剥。",
            "第3步·同级从左到右：40÷8×3=5×3=15。÷和×同级→从左往右。",
            "第4步·逆运算验算：15÷3×8=40→40-15=25→与最初25+15=40一致✓。结果代入原题检验。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "文字题括号加错位置",
                "fix": "\"25加上15的和\"=25+15要加括号。\"除以8的商\"不需要括号，因为除法优先"
              },
              {
                "type": "同级运算跳着算",
                "fix": "40÷8×3必须先40÷8=5，再5×3=15。不能先8×3=24再40÷24"
              },
              {
                "type": "文字题忽略单位",
                "fix": "\"25元加上15元\"=25+15，\"除以8人再乘3天\"=(25+15)÷8×3。带上单位帮助理解"
              }
            ]
      ,
        "oneLineModel": "文字转算式=找\"和/差/积/商\"关键字→确定运算顺序→加括号。算：括号→乘除→加减，同级左到右。"
      ,
        "transfer": "四则运算文字题→五年级列方程解应用题（用x代替未知数）→初中代数式→高中函数表达式。"
      ,
        "advanced": "栈结构的算术表达式求值、逆波兰表示法、计算器中的运算符优先级实现。"
      }
,
  {
        "id": "MATH-04-020",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会安排顺序，而是搞不清哪些工序可以同时做。先试试：把沏茶的6个步骤写在6张纸条上，把有明显先后顺序的用箭头连起来，没有箭头连接的那些——就是可以同时做的。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·列出所有工序：把要做的每件事列出来并标注时间。例如沏茶：洗水壶1分、接水1分、烧水8分、洗茶杯2分、找茶叶1分、沏茶1分。",
            "第2步·找能同时做的事：区分\"必须按顺序\"和\"可以同时做\"的工序。烧水8分钟期间，可以同时洗茶杯(2分)+找茶叶(1分)=3分，空闲5分钟。",
            "第3步·画流程图排顺序：按时间先后排列工序，能并行的画分叉线。洗水壶(1)→接水(1)→烧水(8)∥洗茶杯(2)→找茶叶(1)→沏茶(1)。",
            "第4步·算最短时间：找到关键路径——必须按顺序的最长工序链。洗水壶1+接水1+烧水8+沏茶1=11分钟。验算：所有并行任务都在烧水期间完成了，没多花时间。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "忽略工序依赖",
                "description": "把不能同时做的事情并行了。如\"接水\"和\"洗水壶\"不能同时做，必须先洗壶再接水。",
                "fix": "画箭头表示依赖关系：A→B表示A做完才能做B。能并行的才画分叉。"
              },
              {
                "type": "漏算最长链",
                "description": "只算了并行节省的时间，忘记加上必须串行的工序。如总时长应=最长串行链=烧水8分+前后准备3分=11分。",
                "fix": "用不同颜色标注串行链和并行链，串行链的总时间就是最短完成时间。"
              },
              {
                "type": "田忌赛马策略反用",
                "description": "对策论中不知道用\"下等马对上等马\"的原理，把自己的强项浪费在对方弱项上。",
                "fix": "口诀：最弱消耗最强，中等稳拿，最强收割。先列出全部对阵可能，再选最优方案。"
              }
            ]
      ,
        "oneLineModel": "优化问题=找到不能并行的最长工序链，其余尽量并行塞进去。对策论=用最弱消耗最强，实现整体最优。"
      ,
        "transfer": "沏茶问题→五年级找次品（三分法最优策略）→六年级统筹与规划→初中线性规划（在约束下求最优）。"
      ,
        "advanced": "统筹方法（华罗庚优选法）、多任务调度问题（最短作业优先）、博弈论入门（田忌赛马的数学本质：排列组合+最劣匹配）、项目管理中的关键路径法(CPM)。"
      }
,
  {
        "id": "CHI-05-010",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会用天平，而是没有用\"三分法\"来分组。先试试：9个球，分成3组每组3个。第一次称两组→如果平衡，次品在哪？如果不平衡，次品又在哪？每次称完，次品的范围就缩小到1/3了。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·确定物品总数n：先数一共有几个物品，其中一个次品（轻或重）。例如9个乒乓球中1个次品较轻。",
            "第2步·三分法分组：把n个物品尽量平均分成3组。9个→每组3个。如果是8个→3+3+2（尽量平均）。",
            "第3步·天平称第一次：取两组上秤，平衡→次品在第三组；不平衡→次品在较轻那组（如果次品轻）。9个→两组3个上秤→如不平衡，次品在轻的那3个中。",
            "第4步·递归缩小范围：把含次品那组再三分。3个→1+1+1，取两个上秤→平衡则第三个是次品，不平衡则轻的是次品。总共称2次找到。一般规律：3ⁿ个以内需要n次。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "用二分法而非三分法",
                "description": "把9个分成4+4+1两组称，需要称3次，不如三分法2次。",
                "fix": "三分法最优：每次排除约2/3的物品。分成3组，称两组就能判断次品在哪组。"
              },
              {
                "type": "分组不均导致多称",
                "description": "8个分成4+4或5+3，导致某些分支称的次数超过最优。",
                "fix": "尽量平均分3组。8个=3+3+2，称两组3个→如在3个组→再称1次(共2次)；如在2个组→再称1次(共2次)。"
              },
              {
                "type": "忘记录称量过程",
                "description": "只写出最少称几次，没有写每次怎么分组、怎么根据结果判断。",
                "fix": "用决策树表示：第一次称→两种情况→各自第二次称→结论。每一步都要写清楚。"
              }
            ]
      ,
        "oneLineModel": "找次品最优策略=三分法：每次尽量均分三组，称一次排除约2/3。最多需要⌈log₃n⌉次。"
      ,
        "transfer": "找次品→五年级数学广角（优化思想）→六年级鸽巢问题（抽屉原理）→初中二分查找（有序数组查找）→信息论中的熵。"
      ,
        "advanced": "信息论视角：每次称量提供3种结果（左重/右重/平衡）=log₂3≈1.58比特信息、次品轻重未知时的策略差异、更多应用（假币问题、药片问题）。"
      }
,
  {
        "id": "CHI-04-004",
...
,
  ...
  ,
      ...
      ,
        "oneLineModel": "记单词=音(发音拼写对应)+形(词根词缀)+义(语境造句)+类(联想归类)。会用>会拼。"
      ,
        "transfer": "4年级词汇→5年级词汇量扩充→初中1600词→高中3500词。"
      ,
        "advanced": "词源学（etymology）入门、英语词汇的拉丁/希腊语根源、学术词汇和日常词汇的语域差异。"
      }
,
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是完全不会，而是几个知识点混在一起时不知道该调用哪个。先试试：拿到一道总复习题，先用笔圈出它考的是哪个知识点——\"角的度量\"还是\"运算顺序\"？标签贴对了，方法自然就来了。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·知识导图：三板块——数与运算(大数/乘除法/运算律/小数)、图形与几何(角/三角形/轴对称平移)、统计(条形图)。",
            "第2步·典型错题回顾：大数读写→分级；竖式乘法→对齐；运算顺序→括号优先；角的度量→内外圈。",
            "第3步·综合应用：一道题融合多个知识点。\"等腰三角形顶角40°底角?\"→(180-40)/2=70°→涉及三角形内角和+等腰性质。",
            "第4步·模拟检测：限时完成一套综合卷→逐题分析错因→整理错题本（计算粗心/公式记错/审题不清/方法不会）。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "知识点孤立记忆",
                "fix": "做知识网络图连接各知识点。三角形既涉及角(内角和)又涉及分类(按角/按边)"
              },
              {
                "type": "审题跳步",
                "fix": "审题时用笔画关键词：\"最大\"\"最小\"\"一共\"\"相差\"等"
              },
              {
                "type": "计算粗心",
                "fix": "每道计算题做完用逆运算验算：加法用减法验，乘法用除法验"
              }
            ]
      ,
        "oneLineModel": "四年级数学=数与运算(大数+运算律+小数)+图形几何(角+三角形+对称平移)+统计(条形图)。"
      ,
        "transfer": "四年级总复习→五年级衔接（小数乘除法扩展+多边形面积+分数的引入）→小升初体系化。"
      ,
        "advanced": "四年级数学竞赛知识点（和差倍、鸡兔同笼、定义新运算、等差数列初步）。"
      }
,
  {
        "id": "CHI-04-011",
  ...
  ,
      ...
      ,
        "oneLineModel": "字词学习=形(偏旁拆字)+音(多音字辨析)+义(组词造句)+写(听写自测)。"
      ,
        "transfer": "4年级字词→5年级词汇量扩展→初中文言文实词虚词积累。"
      ,
        "advanced": "汉字六书（象形/指事/会意/形声/转注/假借）、偏旁部首的文化内涵、形声字的声旁规律。"
      }
,
...
,
  ...
  ,
      ...
      ,
        "oneLineModel": "字词学习=形(偏旁拆字)+音(多音字辨析)+义(组词造句)+写(听写自测)。"
      ,
        "transfer": "6年级字词→7年级词汇量扩展→初中文言文实词虚词积累。"
      ,
        "advanced": "汉字六书（象形/指事/会意/形声/转注/假借）、偏旁部首的文化内涵、形声字的声旁规律。"
      }
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是看不懂图，而是把\"一格\"当成了\"1\"。先试试：看纵轴最下面的数字→0到第一个刻度之间标的是多少？如果是0,2,4,6...→一格=2。苹果直条到第6格→6×2=12人。一格不代表1，这是条形图最大的坑。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·读图三要素：标题(说什么)、横轴(类别)、纵轴(数量+一格代表几)。例如\"四(1)班同学最喜欢的水果\"→横轴=水果，纵轴=人数。",
            "第2步·精确读数：直条顶端水平对准纵轴刻度。苹果直条顶端在纵轴\"12\"→苹果=12人。注意一格可能=2→数格子×2。",
            "第3步·根据图回答：最多=最高直条(苹果12人)；最少=最矮直条；苹果比梨多=12-8=4人；总人数=12+8+10+6=36人。",
            "第4步·绘制条形图：定一格代表多少(根据最大值选)→横轴均匀列出类别→纵轴标刻度→画等宽直条→涂色→写标题。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "默认一格=1",
                "fix": "先看纵轴：如果标了0,5,10,15...一格=5。别用格数代替数值"
              },
              {
                "type": "纵轴起点不是0时看直条高度",
                "fix": "纵轴从10开始→直条高度只差1格但实际差5。必须看纵轴数字标注"
              },
              {
                "type": "画图时直条不等宽",
                "fix": "所有直条宽度相同，间距相同。用尺子量好再画"
              }
            ]
      ,
        "oneLineModel": "条形图=直条高度比大小。读图：标题→横轴→纵轴→直条→数据。一格≠1，看标注。"
      ,
        "transfer": "条形统计图→四年级平均数→五年级折线统计图→六年级扇形统计图→初中频数直方图。"
      ,
        "advanced": "复式条形图的图例读法、分段式纵轴条形图、用Excel/GeoGebra生成条形图、数据可视化原则。"
      }
,
  {
        "id": "CHI-04-013",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会乘法口诀，而是试了商之后不知道要不要调整。先试试：456÷48→试商9→9×48=432→456-432=24→24<48→余数小于除数→商9正好。如果乘出来>456→商太大减1。如果余数≥48→商太小加1。试-乘-比-调四步走。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·估商：把除数四舍五入到整十。456÷48→48≈50→456÷50≈9→试商9。",
            "第2步·验商：试商9×48=432→456-432=24<48→商9余24。若余数≥48→商太小加1。",
            "第3步·调商口诀：同头无除商八九（456÷48→首位相同4→45<48→商9），除数折半商四五（除数的一半≈被除数前两位→商5）。",
            "第4步·多位数除：45678÷32→从被除数高位开始逐段除。45÷32=1余13→136÷32=4余8→87÷32=2余23→238÷32=7余14→商1427余14。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "商的中间0漏写",
                "fix": "612÷3=204，十位上的1不够3除→商0占位。不写0变成24就错了"
              },
              {
                "type": "余数≥除数",
                "fix": "每次减完必须检查余数<除数。余24，除数32→24<32✓"
              },
              {
                "type": "调商方向反",
                "fix": "初商×除数>被除数→商太大减1。初商×除数后余数≥除数→商太小加1"
              }
            ]
      ,
        "oneLineModel": "除法=估商→验商→调商。口诀：同头无除商八九，除数折半商四五。余数永远<除数。"
      ,
        "transfer": "除数是两位数的除法→四年级大数除法→五年级小数除法→初中整式长除法。"
      ,
        "advanced": "除数是11的速算（拉面法）、除数是25的速算（×4÷100）、除数是99的循环小数规律。"
      }
,
  {
        "id": "CHI-04-008",
  ...
  ,
      ...
      ,
        "oneLineModel": "学古诗=解诗题→明诗意→想画面→悟诗情→背默写。诗中有画，画中有情。"
      ,
        "transfer": "4年级古诗→5年级诗词量增加/难度提升→初中文言文体系。"
      ,
        "advanced": "格律诗平仄入门、意象系统（月/柳/雁的象征意义）、诗人和时代背景。"
      }
,
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会读数，而是分级分错了。先试试：45678901→从右边开始每4位画一道竖线：01,89,67,45→倒过来45|67|89|01→实际只需要万级和个级两级：45|678901是错误的，应该是4567|8901。从右往左数4位画线，不要从左往右。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·分级：从右往左每4位画一道竖线。例如45678901→4567|8901→万级\"4567\"个级\"8901\"。",
            "第2步·读数：万级读完加\"万\"，亿级读完加\"亿\"。4567|8901→四千五百六十七万八千九百零一。每一级的读法跟个级一样。",
            "第3步·写数：听到\"万\"画分隔线。\"五千零三十万零六百\"→万级=5030，个级=0600→50300600。注意补0占位。",
            "第4步·比较大小：先比位数→位数多的大。位数相同→从最高位开始逐位比。45678901是8位数，8901234是7位数→45678901更大。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "0的读法混乱",
                "fix": "每一级末尾的0不读，中间的0读一个。4005→四千零五(中间0读)，4500→四千五百(末尾0不读)"
              },
              {
                "type": "万级和个级混淆",
                "fix": "每4位一级。45678901→4567|8901，不是45|67|89|01"
              },
              {
                "type": "写数时漏写0",
                "fix": "\"五千零三万\"→万级=5003，个级=0000→50030000（个级4个0占位）"
              }
            ]
      ,
        "oneLineModel": "大数读写=四位分级→万级+个级。读数：万级读完加\"万\"。0的规则：末尾不读中间读。"
      ,
        "transfer": "大数的认识→四年级大数的改写（万/亿作单位）→五年级科学计数法启蒙→初中科学计数法。"
      ,
        "advanced": "四舍五入到万/亿位、近似数与有效数字、中国古代的大数记法（兆/京/垓）、国际数字分级法（千/百万/十亿）。"
      }
,
  {
        "id": "CHI-04-007",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会用运算律，而是看不出来哪些数字能凑整。先试试：把题目里所有数字扫一遍→圈出25、125和4、8→它们凑整是100、1000→优先配对。再找99、101这类接近整百的数→拆成100-1或100+1分配。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·识别可用定律：看到25和4一起→想凑100。25×17×4→交换律凑25×4=100→100×17=1700。",
            "第2步·配凑整十整百：99=100-1→99×45=(100-1)×45=4500-45=4455。用分配律把接近整百的数拆开。",
            "第3步·公因数提取：37×64+37×36→公因数=37→37×(64+36)=37×100=3700。",
            "第4步·变式训练：125×32×25→拆32=8×4→(125×8)×(4×25)=1000×100=100000。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "分配律符号用反",
                "fix": "a×(b-c)=a×b-a×c，注意最后是减号。拆括号后符号跟着括号里的走"
              },
              {
                "type": "交换律用于减法和除法",
                "fix": "只有连加和连乘才能交换。8÷2×4=16，但8×4÷2=16也可以（因为÷2=×1/2）"
              },
              {
                "type": "结合律括号乱加",
                "fix": "a-b-c≠a-(b-c)。右边=a-(b-c)=a-b+c。添括号时减号变号"
              }
            ]
      ,
        "oneLineModel": "运算定律=工具：凑整(交换律/结合律)→简化(分配律正逆用)→速算。核心目标：让计算变简单。"
      ,
        "transfer": "运算定律→五年级小数分数→六年级百分数→初中整式运算→高中代数。"
      ,
        "advanced": "运算律在速算中的应用（头同尾合十、十几乘十几）、印度吠陀数学乘法口诀。"
      }
,
  {
        "id": "CHI-04-003",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会看，而是三视图之间的关系没理清。先试试：用积木实际搭一个简单形状，用手机从正面、右面、上面各拍一张照片——这三张照片就是三视图。现在交换一下，看着照片你能把形状还原出来吗？",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·根据俯视图确定底层：俯视图的每个格子放1个正方体，这是立体图形的\"地基\"。例如俯视图是3×2的矩形→底层就是3列2行共6个方块。",
            "第2步·根据正视图确定每列高度：正视图从前面看，展示每列最高有几层。例如正视图第1列高3、第2列高2、第3列高1→对应俯视图各列从前往后的最高层数。",
            "第3步·根据侧视图确定每行高度：侧视图从右面看，展示每行最高有几层。例如侧视图第1行高2、第2行高1→约束俯视图各行的最高限制。",
            "第4步·综合推理唯一方案：取正视和侧视的约束交集，每格高度=min(正视图该列高度, 侧视图该行高度)。验证：从三个方向再看一遍，确认与给定三视图一致。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "只靠正视图和俯视图忽略了侧视图",
                "description": "正视图和俯视图确定后可能有2种可能，不检查侧视图就下结论。",
                "fix": "三个视图缺一不可。每个可能方案都要同时满足三个方向的视图，缺任何一个都可能漏掉约束。"
              },
              {
                "type": "假设所有格子必须放满",
                "description": "俯视图有5个格位，不一定每个都放方块。有些格位可能是空的（高度=0）。",
                "fix": "俯视图只告诉你\"哪些位置可能有方块\"，具体高度由正视图和侧视图决定，可以为0。"
              },
              {
                "type": "正视图和侧视图的行列方向混淆",
                "description": "把正视图的列对应成侧视图的列（应该是行）。正面看→列（左右），右面看→行（前后）。",
                "fix": "站到实物前：正面看→左右是列；走到右边看→左右变成前后（行）。方向转了90°。"
              }
            ]
      ,
        "oneLineModel": "三视图还原：俯视图定底位，正视图定各列高，侧视图定各行高。每格高度≤min(正视图列高, 侧视图行高)。"
      ,
        "transfer": "观察物体(三)→五年级长方体和正方体（表面积展开图对应三视图）→六年级圆柱与圆锥（三视图中的圆和矩形）→初中三视图与立体几何。"
      ,
        "advanced": "复杂组合体的三视图还原（遮挡问题的深层处理）、正方体展开图与三视图的对应、轴测图与透视图的区别、CAD软件中的三维建模基础。"
      }
,
  {
        "id": "ENG-04-006",
...
,
  ...
  ,
      ...
      ,
        "oneLineModel": "记单词=音(发音拼写对应)+形(词根词缀)+义(语境造句)+类(联想归类)。会用>会拼。"
      ,
        "transfer": "5年级词汇→6年级词汇量扩充→初中1600词→高中3500词。"
      ,
        "advanced": "词源学（etymology）入门、英语词汇的拉丁/希腊语根源、学术词汇和日常词汇的语域差异。"
      }
,
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不理解负号，而是比较负数大小时沿用了正数思维。先试试：在纸上画一条数轴，标出0，然后向左标出-1,-2,-3,-4,-5。现在问自己：-5和-3，谁在左边？左边的那个更小！",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·理解负数：比0小的数，用\"-\"号表示。温度-5°C表示零下5度。海拔-100m表示海平面以下100m。存入+200元，取出-200元（用正负表示相反意义的量）。",
            "第2步·在数轴上标负数：0是分界点，右边正数左边负数。-3在0左边3个单位处，-1.5在-1和-2中间。-3<-1（越往左越小）。",
            "第3步·负数比较大小：数轴上左边的数<右边的数。-5<-3<0<2<5。两个负数比大小，绝对值大的反而小：|-7|=7>|-3|=3→-7<-3。",
            "第4步·负数运算直观理解：温度从-3°C升高5°C→在数轴上从-3向右走5步→到2°C。-3+5=2。3-5=3+(-5)=-2（正数减大于自己的数得负数）。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "认为-3>-2因为3>2",
                "description": "忽略负号，只看数字大小。",
                "fix": "在数轴上标出这两个点，左边的永远小于右边的。-3在-2的左边→-3<-2。"
              },
              {
                "type": "混淆负数和减号",
                "description": "5-3（减号）和-3（负号）书写一样但含义不同。",
                "fix": "减号是运算符号，负号是性质符号。5+(-3)中第一个-是加号（省略），第二个-是负号。"
              },
              {
                "type": "0不是正数也不是负数",
                "description": "孩子有时把0归入正数或负数。",
                "fix": "0是正负数的分界点，它既不是正数也不是负数。正数>0，负数<0。"
              }
            ]
      ,
        "oneLineModel": "负数=比0小的数，在数轴上0左边。越左越小：-5<-3<0<2。两个负数比大小：绝对值大的反而小。"
      ,
        "transfer": "负数→六年级数轴（扩展到负数范围）→初中有理数（整数、分数、正数、负数、0的统一）→初中绝对值。"
      ,
        "advanced": "负数的历史（中国古代《九章算术》中的正负术）、绝对值不等式、数轴上的距离公式、负数的实际应用（债务、温度、海拔）。"
      }
,
  {
        "id": "ENG-04-012",
...
,
  {
    ...
    "solveSteps": [
            "第1步·算总量：把所有数据值加在一起。语文92/数学88/英语96→92+88+96=276。",
            "第2步·数份数：确定一共有几组数据参与平均。3门课→份数=3。",
            "第3步·总量÷份数：276÷3=92(平均数)。平均数=总量÷份数。",
            "第4步·读图验证：条形图中找到每组的数据值，与计算平均值结果对比，确保一致。"
          ],
    "commonMistakes": [
      {"type": "平均数=(最大+最小)÷2", "description": "误以为平均数就是最大和最小的中间值。正解：必须把所有数据加总后再除以总份数。只有在对称分布时才碰巧相等。", "fix": "口诀：全部加起来，再数有几份，相除得平均。不要偷懒只取两头。"},
      {"type": "条形图纵轴起点不是0时误判", "description": "直接用直条高度判断大小，忽略了纵轴被截断。正解：必须看纵轴数据标注而非直条视觉高度，被截断的纵轴会严重夸大差异。", "fix": "先看纵轴起点是不是0。不是0的话，读每条顶部的具体数字，不要相信眼睛。"},
      {"type": "复式条形图混搭比较", "description": "忽略图例，把男生/女生或A组/B组的数据混在一起比较。正解：先看右上角图例确定每种颜色代表什么，再分别读取同组内和不同组间的数据。", "fix": "两步走：①看图例→确定颜色含义；②同色竖条之间才能比较，不同色竖条是不同类。"}
    ],
    "oneLineModel": "平均数 = 总量 ÷ 份数。它不是'中间值'，而是'把总量平均分给每一份后每份有多少'。",
    "transfer": {
      "description": "平均数→'代表值'概念，为五年级可能性（概率期望）和六年级统计图选择奠定基础；复式条形图的数据分组思维，移植到折线统计图的多线比较和扇形统计图的百分比分配。",
      "relatedTopics": ["五年级可能性·概率期望", "六年级折线统计图·多线比较", "六年级扇形统计图·百分比分配", "初中加权平均数"]
    },
    "advanced": {
      "description": "从简单平均数到加权平均数（六年级按比例分配的前身），再到数据分布形态（中位数与众数的区别）、方差入门（数据离散程度）。",
      "futureTopics": ["加权平均数（按比例分配）", "中位数与众数（数据分布形态）", "方差与标准差（数据离散程度）", "箱线图与数据分布可视化"]
    },
    "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会加除法，而是漏看\"需要平均的是几份\"。先试试：圈出题目里所有要参与平均数计算的数据值，再数一数有几个，最后用总量除以份数。",
              "interactionType": "dynamic-question"
            }
  }
,
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会转，而是旋转的三个要素没弄清楚。先试试：在图上用红笔圈出旋转中心O，用蓝笔标旋转方向箭头，用绿笔写旋转角度90°。然后一个一个顶点来——先把OA连起来，逆时针转90°，画好A'——再做下一个。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·确定旋转三要素：旋转中心（绕哪个点转）、旋转方向（顺时针/逆时针）、旋转角度（90°/180°/270°）。例如三角形绕点O逆时针旋转90°。",
            "第2步·画旋转弧线：连接旋转中心O与图形上一个顶点A，以O为圆心、OA为半径，按旋转方向画90°弧，弧的终点即A'。或用三角板：OA为一边，逆时针转90°的垂线为另一边。",
            "第3步·逐个顶点旋转：对每个顶点重复第2步，得到所有对应顶点A'B'C'。验证：OA=OA'，OB=OB'，OC=OC'（对应点到旋转中心距离相等）。",
            "第4步·连点成图并验证：将旋转后的顶点依次连接，得到旋转后的图形。验证：原图和新图形状大小完全一样，对应线段长度相等，旋转角∠AOA'=90°。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "旋转方向搞反",
                "description": "要求逆时针转90°，结果画成了顺时针。",
                "fix": "用手比划：逆时针=向左上转，顺时针=向右下转。在图上画个小箭头标注方向。"
              },
              {
                "type": "旋转中心搞错",
                "description": "绕点O旋转，但实际绕了图形自身的中心旋转。",
                "fix": "先标出旋转中心O，用尺子测量每个顶点到O的距离，旋转后距离不变。"
              },
              {
                "type": "旋转后图形变形",
                "description": "只转了两个顶点，第三个凭感觉画，导致新图形失真。",
                "fix": "每个顶点都要逐个精确旋转。旋转后量一下新图形的边长，应该和原图完全一致。"
              }
            ]
      ,
        "oneLineModel": "旋转=绕定点转角度。三要素：旋转中心、方向、角度。对应点到中心距离相等，旋转角相等。"
      ,
        "transfer": "旋转→五年级位置（旋转后的坐标变化）→六年级图形的运动综合（平移+旋转+轴对称）→初中全等三角形（旋转变换证明）。"
      ,
        "advanced": "旋转对称图形（如正方形旋转90°后重合）、旋转角平分线、坐标系中的旋转变换矩阵入门、旋转变换在证明全等中的应用。"
      }
,
  {
        "id": "MATH-06-010",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会看扇形图，而是忘了算圆心角来精确判断大小。先试试：把每个百分数乘360°，算出对应的圆心角——然后用这些角度去比，哪个角度最大，哪个类别的占比就最大。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·看标题和图例：标题告诉图在说什么，图例或标签标注每个扇形代表什么。例如\"六(1)班最喜欢的运动项目\"→足球25%、篮球30%、乒乓球20%、跳绳15%、其他10%。",
            "第2步·算圆心角：百分数×360°=圆心角。足球25%→0.25×360°=90°（直角）。篮球30%→0.3×360°=108°。验证：所有扇形圆心角之和=360°。",
            "第3步·用百分数算数量：如果全班40人，足球人数=40×25%=10人，篮球=40×30%=12人。用扇形图面积大小直观比较——扇形越大占比越大。",
            "第4步·判断能否用扇形图：各部分占整体的百分比，且各部分之和=100%（或1）。不适合表示\"喜欢足球的有12人\"这类绝对数量（此时用条形图更好）。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "忘算圆心角直接凭眼睛判断大小",
                "description": "两个扇形看起来差不多大，但不精确计算圆心角就无法确定谁更大。",
                "fix": "圆心角=百分数×360°。用计算器精确算。15%×360°=54°，20%×360°=72°，差18°肉眼难辨。"
              },
              {
                "type": "把扇形当独立图形忘记和100%对比",
                "description": "只知道足球是25%，不知道剩下75%怎么分配，无法判断足球是不是最多。",
                "fix": "先列出所有类别的百分数，总和应为100%。然后排序找最大/最小/相差多少。"
              },
              {
                "type": "扇形图误用于不适用场景",
                "description": "用扇形图表示\"每年GDP增长量\"（不是占比，是绝对量），应用折线图。",
                "fix": "扇形图=展示部分与整体的占比关系。如果数据不是\"占比\"就不该用扇形图。"
              }
            ]
      ,
        "oneLineModel": "扇形图看占比：圆心角=百分数×360°，扇形面积比=百分数比。适用条件：各部分之和=100%。"
      ,
        "transfer": "扇形统计图→五年级折线统计图（看趋势）→六年级统计图选择（根据目的选图）→初中饼图和环形图。"
      ,
        "advanced": "复式扇形图（内外环对比）、三维扇形图的视觉误导问题、百分比堆积图与扇形图的对比、Excel中生成扇形图。"
      }
,
  {
        "id": "MATH-04-029",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会看，而是没搞清楚\"从哪边看\"对应的是哪个方向。先试试：用手把立体图形摆在面前，然后走到它的正前面蹲下来，只用一只眼睛看——你看到几列？每列最高几层？这就是正视图。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·定方向：明确从哪个方向观察——前面（正视图）、右面（侧视图）、上面（俯视图）。例如用4个小正方体搭成的L形，从前面看是2层3列的形状。",
            "第2步·逐层逐列数：从该方向看过去，每一列最高有几个方块。例如L形从前面看：第1列最高2个，第2列最高1个，第3列最高1个→画出轮廓。",
            "第3步·画出视图：在方格纸上用阴影标出每一列的高度。前面看→横向是列，纵向是层。上面看→画出每个位置是否有方块（俯视图是\"脚印图\"）。",
            "第4步·根据视图还原：给定三个方向的视图，推出立体图形的唯一拼法。先根据俯视图确定底层位置，再根据正视图和侧视图确定每列高度。验证：正视图的最大高度=侧视图中对应列的高度。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "混淆左右方向",
                "description": "从右面看时把左右搞反。从右面看的第1列=立体图形最右边的一列。",
                "fix": "面对实物时，右手边就是\"右面\"，左手边就是\"左面\"。闭上一只眼单眼观察更准确。"
              },
              {
                "type": "漏数遮挡的方块",
                "description": "前面看时前层方块遮挡了后层，孩子只画了前层。如2排方块，前排高1后排高2→前面看应画出2的高度。",
                "fix": "从该方向看，取每列所有层中的最大高度。遮挡不等于不存在。"
              },
              {
                "type": "视图还原不唯一时硬猜",
                "description": "有些三视图可以对应多种立体拼法，孩子只想到一种。",
                "fix": "先画俯视图→在每个格子里填可能的高度范围→用正视图和侧视图约束缩小范围→列出所有可能方案。"
              }
            ]
      ,
        "oneLineModel": "三视图：前面看列最高，右面看行最高，上面看位置有无。还原时俯视图定位置，正侧图定高度。"
      ,
        "transfer": "观察物体(二)→五年级观察物体(三)（三视图还原复杂立体）→五年级长方体和正方体（表面积展开图）→初中三视图与立体几何。"
      ,
        "advanced": "三视图还原复杂组合体（正视图+侧视图+俯视图联合推理）、正方体展开图11种（1-4-1型6种+2-3-1型3种+2-2-2型1种+3-3型1种）、空间坐标系。"
      }
,
  {
        "id": "CHI-05-013",
...
,
  {
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会移动图形，而是平移时数格子数错了。先试试：在方格纸上找一个顶点，手指按住它，一格一格往右数7格，停下——这个位置对不对？用同样的方法检查每一个顶点。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·找对称轴：沿一条直线对折后图形两边能完全重合，这条线就是对称轴。例如正方形有4条对称轴（2条对角线+2条对边中点连线）。长方形只有2条（对边中点连线，对角线不是对称轴）。",
            "第2步·补全轴对称图形：先找已知点关于对称轴的对称点→对称轴是对应点连线的垂直平分线。例如点A距对称轴3格，A'也在对称轴另一侧3格处。",
            "第3步·数格子平移：确定平移方向和格数。图形向右平移7格→每个顶点都向右数7格→标出新位置。例如房子图形：屋顶点(3,8)→向右7格→(10,8)。",
            "第4步·连点成图验证：将新位置的点依次连接成图。验证：原图和新图形状大小完全一样，对应点连线平行且相等。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "平移格数数错",
                "description": "\"向右平移7格\"从原图边缘开始数而非从对应点开始数，移完后两图中间距≠7格。",
                "fix": "选一个顶点，从它的原位置数到新位置，必须刚好是7格。每个顶点都要验证。"
              },
              {
                "type": "把长方形对角线当对称轴",
                "description": "长方形只有2条对称轴（对边中点连线），孩子却画了对角线。",
                "fix": "折纸验证：沿对角线对折，长方形两半不能完全重合→对角线不是对称轴。"
              },
              {
                "type": "平移后图形变形",
                "description": "部分点移对了部分点移错了，导致新图形走样。",
                "fix": "每个顶点独立数格、独立验证。所有顶点的新位置连成图形后，用尺子量边长看是否和原图一致。"
              }
            ]
      ,
        "oneLineModel": "轴对称=沿对称轴翻折重合，对应点到对称轴距离相等。平移=每个点沿同一方向移动相同距离，形状大小不变。"
      ,
        "transfer": "图形的运动(二)→四年级观察物体（多角度视图）→五年级图形的运动(三)（旋转）→六年级图形的运动综合（平移+旋转+轴对称三者关系）→初中几何变换与全等。"
      ,
        "advanced": "多次平移的复合（最终位置=各次位移向量的和）、对称在镜面反射中的应用、利用平移计算不规则图形的周长（如楼梯问题）、坐标系下的平移公式(x+a, y+b)。"
      }
,
  {
        "id": "MATH-04-030",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算数，而是不知道怎样才算\"营养均衡\"。先试试：把你今天午餐吃的菜列出来，查一下每种菜的热量，加起来看看和推荐值差多少？然后试着用低热量的菜替换一两个高热量的，看总热量变化了多少。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·收集数据：列出每种菜的热量(千卡)、蛋白质(g)、脂肪(g)。例如红烧肉：热量350千卡、蛋白质20g、脂肪30g；炒青菜：热量80千卡、蛋白质5g、脂肪3g。",
            "第2步·设计搭配方案：一荤一素一汤，计算总热量。红烧肉350+炒青菜80+紫菜汤30=460千卡。10岁儿童午餐推荐热量约600-700千卡，偏低需调整。",
            "第3步·用条形图对比：横轴标方案名（方案A、B、C），纵轴标总热量。画出各方案的直条，加一条推荐值虚线（650千卡），看哪个方案最接近。",
            "第4步·优化与结论：调整菜品使总热量接近推荐值。将红烧肉换成热量适中的宫保鸡丁(280千卡)→280+80+30=390→仍偏低→加一个卤蛋(80千卡)=470千卡。写出推荐方案及理由。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "只看热量不看营养均衡",
                "description": "凑够热量但全是油炸食品，蛋白质和脂肪比例失衡。",
                "fix": "三餐热量比3:4:3，蛋白质+碳水+脂肪≈15%+55%+30%。不只算热量，还要算三大营养素。"
              },
              {
                "type": "数据来源不标注",
                "description": "直接写热量值但不说明数据来源，无法验证是否准确。",
                "fix": "每个数据要有出处：包装袋营养成分表/学校食堂菜谱/食物成分表。"
              },
              {
                "type": "方案对比不画图",
                "description": "只有文字描述不做可视化，看不出各方案差异。",
                "fix": "至少画一个条形图对比各方案总热量，再画一个复式条形图对比热量+蛋白质+脂肪。"
              }
            ]
      ,
        "oneLineModel": "营养午餐=数据收集→方案设计→图表对比→优化调整。综合运用统计图表和数的运算解决真实问题。"
      ,
        "transfer": "营养午餐→四年级条形统计图（数据可视化对比）→四年级平均数（各方案平均热量）→五年级折线统计图→六年级百分数（营养素占比用扇形图）。"
      ,
        "advanced": "热量计算公式（蛋白质×4+碳水×4+脂肪×9千卡/克）、BMI指数计算和应用、中国居民膳食指南的数学建模、多目标优化（热量+营养+成本三目标）。"
      }
,
  {
        "id": "MATH-05-007",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会算分数，而是没想清楚\"有哪些可能结果\"和\"哪些是有利的\"。先试试：口袋里有3个红球、2个蓝球，把所有球编上号：红1红2红3蓝1蓝2。闭眼摸一个，有几种可能？其中摸到红球有几种？用这两个数相除就是概率。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·列所有可能结果：掷一个骰子有{1,2,3,4,5,6}共6种等可能结果。摸球：红3个、蓝2个→共5个球，每种结果被摸到的概率=1/5。",
            "第2步·数有利结果数：掷骰子得偶数→有利结果={2,4,6}=3种。摸到红球→红球3个→有利结果=3。",
            "第3步·算概率：有利结果数÷所有可能结果数。偶数概率=3÷6=1/2=0.5。摸红球=3÷5=0.6。",
            "第4步·判断事件类型：概率=1→必然事件（太阳从东边升起）；概率=0→不可能事件（掷骰子得7）；0<概率<1→随机事件。摸到红球概率0.6→可能性比较大，但不是一定。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "混淆频率和概率",
                "description": "\"掷10次硬币出了7次正面，所以正面概率是7/10\"❌。概率是理论值（1/2），频率是实验结果。",
                "fix": "概率=理论上有利结果数÷所有可能结果数。频率=实验中实际发生次数÷实验总次数。实验次数越多，频率越接近概率。"
              },
              {
                "type": "忽略\"等可能性\"前提",
                "description": "掷两颗骰子和为7有6种组合(1,6)(2,5)(3,4)(4,3)(5,2)(6,1)，和=2只有(1,1)1种。但不是所有和等可能。",
                "fix": "列出所有36种有序结果（骰子1,骰子2），再数每种和的出现次数。"
              },
              {
                "type": "\"一定\"\"可能\"\"不可能\"用词不准",
                "description": "把\"明天可能下雨\"（概率约30%）说成\"明天一定下雨\"。",
                "fix": "一定=概率100%，不可能=概率0%，可能=0%<概率<100%。根据天气预报的概率值选词。"
              }
            ]
      ,
        "oneLineModel": "概率=有利结果数÷所有可能结果数。0≤概率≤1，0=不可能，1=必然。频率趋近概率（大数定律）。"
      ,
        "transfer": "可能性→五年级统计图（用图表展示概率）→六年级可能性进阶（独立事件、乘法原理）→初中概率论（古典概型）→高中条件概率。"
      ,
        "advanced": "几何概率（面积比）、期望值计算（加权平均数与概率结合）、蒙特卡洛方法（用随机实验求近似解）、独立事件与互斥事件的区别。"
      }
,
  {
        "id": "MATH-06-005",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会用量角器，而是搞错了\"从哪个方向开始偏\"。先试试：\"东偏北30°\"——先在图上画一条正东方向线（向右的箭头），然后从这条线开始往北（往上）偏30°，这条斜线就是目标方向。东偏北≠北偏东！",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·确定观测点：明确\"从哪看\"。\"学校在公园的东偏北30°方向\"→观测点是公园。\"公园在学校的什么方向\"→观测点变成学校（方向相反）。",
            "第2步·量方向角：用量角器从\"基准方向\"量起。东偏北30°=从正东方向往北偏30°。北偏东60°=从正北往东偏60°。东偏北30°=北偏东60°（互余关系）。",
            "第3步·量距离：用比例尺换算。图上的1cm代表实际的100m→图上3.5cm→实际350m。标注：\"学校在公园东偏北30°方向350m处\"。",
            "第4步·反向推理：已知\"学校在公园东偏北30°350m处\"→求\"公园在学校的什么方向\"→方向相反（西偏南30°），距离相同（350m）。验证：东←→西，北←→南对调。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "基准方向选错",
                "description": "\"东偏北30°\"从正北开始量30°（错误），应该从正东开始量。",
                "fix": "\"A偏B\"中A是基准方向。东偏北=从东往北偏，北偏东=从北往东偏。"
              },
              {
                "type": "反向描述时只反方向不反偏角",
                "description": "学校在公园东偏北30°→公园在学校\"西偏南30°\"（正确）。孩子写成\"西偏北30°\"。",
                "fix": "反向=方向全反+偏角不变。东→西，北→南；东偏北→西偏南。"
              },
              {
                "type": "比例尺换算忘带单位",
                "description": "1:100000的比例尺，图上5cm→实际5×100000=500000cm→应换算成5km。",
                "fix": "统一换算成最合适的单位：500000cm=5000m=5km。大数字用km，小数字用m。"
              }
            ]
      ,
        "oneLineModel": "位置=观测点+方向角(从基准方向量)+距离(比例尺换算)。反向：方向全反，偏角和距离不变。"
      ,
        "transfer": "位置与方向→五年级数对(列,行)（直角坐标）→六年级比例尺→初中极坐标系（方向+距离=极坐标原型）→高中向量。"
      ,
        "advanced": "方位角的表示法（军事用密位制）、极坐标系入门、经纬度定位原理、GPS定位的数学基础（三边测量）。"
      }
,
  {
        "id": "MATH-04-019",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会画直条，而是没有检查纵轴起点是否为0。先试试：如果一组数据是98、99、100，纵轴从95开始画，98和100的直条高度差会变成多少倍？记住：条形图纵轴不标0，就是视觉欺骗。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·整理数据：将原始数据按类别归组，制成频数表。例如统计四(1)班40人最喜欢的水果：苹果12人、香蕉8人、橘子15人、葡萄5人。",
            "第2步·定纵轴刻度：找最大值15，确定每格代表几人（如1格=2人），纵轴标注0、2、4……16。起点必须从0开始，否则直条高度会误导比较。",
            "第3步·画横轴画直条：横轴等距标注类别名称（苹果、香蕉、橘子、葡萄），根据频数在对应位置画直条，直条宽度一致、间距相等。苹果画到12对应的刻度线。",
            "第4步·标注与读图：标题写在图上方，横轴标\"水果种类\"，纵轴标\"人数\"。读图时看直条顶端对应的刻度值，橘子的直条最高=15人最受欢迎。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "纵轴起点不是0",
                "description": "纵轴不从0开始导致直条高度差异被夸大。如数据12和15，从10开始画看起来差5倍。",
                "fix": "条形图纵轴必须从0开始。如需省略部分，用锯齿线标记纵轴断裂处。"
              },
              {
                "type": "直条宽度不均",
                "description": "有的直条画得宽、有的画得窄，造成视觉误导。",
                "fix": "用尺子量好每个直条的宽度（如1cm），直条间距也保持一致。"
              },
              {
                "type": "每格代表值不一致",
                "description": "纵轴上半段每格代表1，下半段每格代表2，导致读图混乱。",
                "fix": "纵轴刻度必须均匀：确定一个单位值后，整个纵轴都用同一个单位值。"
              }
            ]
      ,
        "oneLineModel": "条形图看直条高度比大小，纵轴必须从0开始、刻度均匀，直条等宽等距。"
      ,
        "transfer": "条形统计图→四年级平均数（用条形图数据算平均）→四年级复式条形统计图（两组数据并列对比）→五年级折线统计图（趋势代替大小）→六年级扇形统计图（占比代替绝对量）。"
      ,
        "advanced": "复式条形统计图（双/多直条并列对比）、纵轴缩略图的使用规范（何时用锯齿线）、从条形图推断中位数与众数、用Excel生成条形图。"
      }
,
  {
        "id": "MATH-05-005",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会数数，而是把列和行的顺序搞反了。先试试：用手指在方格纸上从原点(0,0)出发，先向右数3格（这是列），再向上数5格（这是行），停下来的位置就是(3,5)。记住：(列,行)=(先右,后上)。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·确定行列方向：列=竖着数（从左往右），行=横着数（从下往上）。例如教室座位第3列第5行→数对(3,5)。",
            "第2步·写数对：(列,行)顺序不可反。电影院第8排第6座→(6,8)（列=座位号=6，行=排号=8）。注意：不同场景\"排\"和\"座\"对应行列不同。",
            "第3步·在方格图中标位置：横轴对应列，纵轴对应行。点(3,5)→从原点起向右走3格，再向上走5格。",
            "第4步·用数对描述图形运动：三角形顶点A(2,3)向右平移4格→A'(6,3)（列+4,行不变），向上平移2格→A''(6,5)（行+2）。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "行列顺序颠倒",
                "description": "把(3,5)理解成第3行第5列，坐标轴上都标错了位置。",
                "fix": "口诀：先列后行，（列,行）。记法：列→x轴→横着数→第一个数字；行→y轴→竖着数→第二个数字。"
              },
              {
                "type": "原点(0,0)位置搞错",
                "description": "把方格纸最左下角当作(1,1)而非(0,0)，导致所有点偏移。",
                "fix": "先确认坐标系原点在哪里，通常方格纸左下角是(0,0)或题目会标注。不确定时读题确认。"
              },
              {
                "type": "平移方向搞反",
                "description": "向右平移本应列+5却算成列-5。",
                "fix": "向右=列增大（+），向左=列减小（-）；向上=行增大（+），向下=行减小（-）。"
              }
            ]
      ,
        "oneLineModel": "位置=(列,行)，列从左往右数，行从下往上数。平移时：左右改变列(±)，上下改变行(±)。"
      ,
        "transfer": "数对→五年级图形的运动（旋转：用数对描述旋转后位置）→六年级位置与方向（极坐标：方向+距离）→初中平面直角坐标系。"
      ,
        "advanced": "坐标系中的距离公式（横平竖直距离=|x₂-x₁|+|y₂-y₁|）、中点公式((x₁+x₂)/2,(y₁+y₂)/2)、对称点坐标规律、笛卡尔坐标系的历史。"
      }
,
  {
        "id": "MATH-05-017",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会画折线，而是把横轴的年份和纵轴的值对错了。先试试：拿一把尺子，从横轴的\"2022年\"垂直向上，到纵轴620亿的位置描一个点——每个点都这样操作，描完再连线。",
              "interactionType": "dynamic-question"
            },
        "chip": {
  ...
  ,
        "solveSteps": [
            "第1步·整理数据表：将数据按时间顺序排列。例如某市2020-2024年GDP：20年500亿、21年550亿、22年620亿、23年710亿、24年800亿。",
            "第2步·定横轴纵轴：横轴=时间（等距标注年份），纵轴=数值（从略低于最小值开始到略高于最大值）。纵轴每格代表值要均匀。",
            "第3步·描点连线：根据每对(年份,GDP)在对应位置描点，然后用直线段依次连接各点。折线的斜率=变化速度——线越陡变化越快。",
            "第4步·读图分析趋势：上升→增长、下降→减少、平缓→稳定。复式折线图看两条线的相对位置→谁在上面谁的值大；两线间距变化→差距扩大或缩小。"
          ]
      ,
        "commonMistakes": [
              {
                "type": "纵轴起点不是0导致趋势夸大",
                "description": "纵轴从460开始，500到800的变化看起来像翻了好几倍。",
                "fix": "需要时用锯齿线标记纵轴断裂处。读图时要看纵轴实际数值，不要只看折线陡峭程度。"
              },
              {
                "type": "折线图的点描错位置",
                "description": "年份和数值对应错位。如2022年的值描在2023的位置上。",
                "fix": "描一个点就做一个标记。用尺子从横轴年份量上去，再在对应数值处做记号。"
              },
              {
                "type": "混淆折线图和条形图的用途",
                "description": "用折线图比大小（应看趋势），用条形图看变化（应看大小）。",
                "fix": "折线图=看变化趋势（时间序列），条形图=看数量多少（类别比较）。"
              }
            ]
      ,
        "oneLineModel": "折线图看趋势：描点→连线→读斜度。上升=增长，下降=减少，平缓=稳定。复式看两线间距变化。"
      ,
        "transfer": "折线统计图→五年级可能性（用折线展示频率变化）→六年级统计图选择（按目的选图）→初中函数图像。"
      ,
        "advanced": "移动平均线（平滑折线的波动）、增长率计算与折线图结合、双纵轴折线图（不同量纲的数据在同一图上比较）、Excel生成动态折线图。"
      }
,
  {
        "id": "MATH-05-011",
        ...
        "aiDiagnosis": {
              "trigger": "卡住时提供",
              "action": "你在这里卡住，通常不是不会看数字，而是没理解每一位数字代表什么。先试试：把你的身份证号码写出来，对着\"6位地址+8位生日+3位顺序+1位校验\"这个格式，把每位的含义标注出来。你会发现它就像一个密码一样有规律。",
              "interactionType": "dynamic-question"
            },
        "chip": {
    ...
    "solveSteps": [
            "第1步·理解编码结构：身份证18位=6位地址码+8位出生日期+3位顺序码+1位校验码。例如110101199001011234→110101=北京东城区，19900101=出生日，123=顺序码，4=校验码。",
            "第2步·提取关键信息：邮政编码6位=省2位+市1位+县1位+投递局2位。100010=北京(10)+东城(00)+某支局(10)。学号=入学年份4位+班级2位+序号2位→20210325=2021年入学3班25号。",
            "第3步·编码的校验：身份证第18位校验码=前17位按权重计算的余数查表。ISBN书号第13位校验码同原理。验证：用前几位算出的校验码与第18位一致→编码正确。",
            "第4步·设计自己的编码：为全班同学编学号→规则必须唯一（无重号）、简洁（位数尽量少）、可扩展（预留新同学编号空间）。例如2026201401=2026年入学2班14号01。"
          ],
  ...
  ,
        "oneLineModel": "编码=有结构的信息压缩。规则：每一位/段有固定含义，编码必须唯一且可验证。"
      }
,
